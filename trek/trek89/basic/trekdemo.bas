...
# gwba - GW-BASIC tokenized file (or BASICA)
    5 DEF SEG: POKE 106,0
   10 KEY OFF : CLS : DEFINT A-Z
   15 ON ERROR GOTO 65100
   20 CURY1=1:CURX1=1:LEVEL=8
  147 '
  800 CLS :STAR=1: LOCATE 2,1: PRINT "                                                                   ⁄ÕÕÕÕÕÕø"
  801 SOND=SOND+1
  810 PRINT "                   …ÕÕª                   …€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€"
  820 PRINT "       ‹‹‹‹‹‹‹‹‹€€€€€€€€€€‹‹‹‹‹‹‹‹        »€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€Õº"
  830 PRINT " ﬂ€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€€ﬂ          ∫∫"
  840 PRINT "             »ÕÕÕÕÕÕÕÕÕÕÕÕÕÕº ﬂ€€€€€€€            ∫∫"
  850 PRINT "                                ﬂ€€€€€€           ∫∫"
  860 PRINT "                               ª  ﬂ€€€€€          ∫∫"
  870 PRINT "                               Ã‹€€€€€€€€€€€€€€€€€€€€€€€€ª"
  880 PRINT "                               Ãﬂ€€€€€€€€€€€€€€€€€€€€€ﬂﬂﬂﬂ"
  890 PRINT "                               º"
  900 LOCATE 17,40: COLOR 15,0: PRINT "V I D E O   T R E K    8 8": COLOR 7,0
  990 GOTO 50000
  993 '
  995 PRINT 
  997 FOR A=1 TO 3: NEXT A: FOR A=1 TO 200: NEXT A: RETURN 
 1000 PLAY "MB": PLAY "L64MST255": GOSUB 20035: GOSUB 20100
 1005 IF KL+RM=0 THEN DEAD=0: GOTO 61000
 1006 IF EDATE!-SDATE!<0.1 THEN DEAD=12: GOTO 61000
 1008 IF SHP<100 THEN GOSUB 20300: COLOR 16,7: PRINT "  SHIELDS CRITICAL !!!   Redistribute power immediately  ";: COLOR 7,0: GOSUB 45700
 1010 GOSUB 23600: GOSUB 23600
 1015 'Allow enemy fire
 1020 FIRE=2: GOSUB 40100
 1025 ' Update clock
 1030 GOSUB 23600:FIRE=0: GOSUB 40100
 1035 ' Fire phasers
 1040 W=8:C=6: GOSUB 27025
 1045 ' Update clock
 1050 GOSUB 23600: GOSUB 40100
 1055 ' Fire phasers
 1060 W=8:C=4: GOSUB 27025
 1075 ' Fire photon trps
 1080 W=8:C=4: GOSUB 28030
 1085 ' Update clock
 1090 GOSUB 23600: GOSUB 40100
 1095 ' Fire photon trps
 2000 W=8:C=2: GOSUB 28030
 2005 ' Fire photon trps
 2010 W=8:C=2: GOSUB 28030
 2015 ' Update clock
 2020 GOSUB 23600:FIRE=2: GOSUB 40100
 2025 ' Fire phasers
 2030 W=8:C=7: GOSUB 27025
 2035 ' Update clock
 2040 GOSUB 23600:FIRE=2: GOSUB 40100
 2045 ' Fire phasers
 2050 W=8:C=7: GOSUB 27025
 2055 ' Update clock
 2060 GOSUB 23600:FIRE=0: GOSUB 40100
 2065 ' Fire photon trps
 2070 W=8:C=7: GOSUB 28030
 2075 ' Update clock
 2080 GOSUB 23600:FIRE=1: GOSUB 40100
 2085 ' Fire photon trps30
 2090 W=8:C=5: GOSUB 28030
 2095 ' Update clock
 3000 GOSUB 23600:FIRE=2: GOSUB 40100
 3005 ' Fire A.M.P.
 3010 W=8:C=2: GOSUB 30030
 3015 ' Update clock
 3020 GOSUB 23600:FIRE=2: GOSUB 40100
 3030 GOTO 2030
19000 STOP 
19995 '
19997 '
19998 ' Draw screen
19999 '
20000 CLS : LOCATE 3,1: PRINT "…ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕª  …ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕ—ÕÕª"
20001 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20002 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20003 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20004 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20005 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20006 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20007 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20008 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20009 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20010 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20011 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20012 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20013 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20014 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20015 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20016 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20017 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20018 PRINT "«ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂  «ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ≈ƒƒ∂"
20019 PRINT "∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫  ∫  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ≥  ∫"
20020 PRINT "»ÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕº  »ÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕœÕÕº"
20023 LOCATE 1,20: COLOR 15,0: PRINT "V I D E O   T R E K    8 8";: COLOR 7,0
...
20099 '
20100 LOCATE 3,76: PRINT CND$;: LOCATE 6,75: PRINT "    ";: LOCATE 8,78: PRINT USING "###";LRP;: LOCATE 9,78: PRINT USING "###";SRP;: LOCATE 10,78: PRINT USING "###";CPP;: LOCATE 11,78: PRINT USING "###";SHP;: IF RSP<1000 THEN COLOR 23,0
20105 LOCATE 6,75: PRINT RSP;: COLOR 7,0
...
20699 '
20700 IF ( FN RAND(SRP)*4+SRP)<50 THEN GOSUB 20600: RETURN ELSE FOR Y=0 TO 9: FOR X=0 TO 9: LOCATE 4+Y*2,35+X*3: ON ((ST(X,Y)+1) AND 15) GOSUB 20780,20781,20782,20783,20784,20785,20786,20787,20788,20789
...
20786 COLOR 23,0: PRINT KL$;: COLOR 7,0: RETURN 
...
20799 '
20800 LOCATE 4+OSTY*2,35+OSTX*3: PRINT "  ";: LOCATE 4+NSTY*2,35+NSTX*3: COLOR 15,0: PRINT ET$;: COLOR 7,0: RETURN 
20897 '
20898 'Update quadrent marker
20899 '
20900 LR(OQTX,OQTY)=QT(OQTX,OQTY): LOCATE 4+OQTY*2,2+OQTX*3: IF (LR(OQTX,OQTY) AND 128) THEN COLOR 0,7: PRINT ST$;: COLOR 7,0: GOTO 20920
...
20920 LOCATE 4+NQTY*2,2+NQTX*3: COLOR 15,0: PRINT ET$;: COLOR 7,0: IF LRP>5 THEN LRP=LRP-1
20930 RETURN 
20995 '
20997 '
20998 '
...
21015 IF LEVEL<5 THEN GOSUB 20200: PRINT CHR$ (157);" = Starbase        ";: COLOR 0,7: PRINT ST$;: COLOR 7,0: PRINT " = Supernova        #1 - #9 = Number of enemies";
...
21900 GOSUB 26900:LR(X,Y)=QT(X,Y): LOCATE 4+Y*2,2+X*3: IF (LR(X,Y) AND 128) THEN COLOR 0,7: PRINT ST$;: COLOR 7,0: RETURN 
...
22020 GOSUB 20200: PRINT "Romulan  ";RM$;"     Klingon ";KL$;"   Tholian   ";TH$;"   Commander  ";: COLOR 23,0: PRINT KL$;: COLOR 7,0: PRINT "   Enterprise ";: COLOR 15,0: PRINT ET$;: COLOR 7,0
22025 GOSUB 20300: PRINT "Star     ";ST$;"     Planet  ";PL$;"    Starbase ";BS$;"   Black hole ";BH$;
22030 GOSUB 20700: GOSUB 20800: RETURN 
22995 '
22997 '
22998 ' Redistribute ship's energy
22999 '
...
23055 DEV=A:RSP=RSP+B: IF B>0 AND C=0 THEN 23060 ELSE GOSUB 20300: PRINT A$;" not available, sir !";: FOR X=1 TO 1000: NEXT X: RETURN 
...
23699 '
23700 GOSUB 40000:A= VAL (A$): IF A<1 OR A>8 THEN A=0: RETURN ELSE RETURN 
23797 '
...
25115 IF W>7 AND RND (1)>0.9 THEN GOSUB 20200: PRINT SP$;"We are entering a time warp";: IF FN L(1)>14 THEN DEAD=5: GOTO 61000 ELSE GOTO 28700
...
25899 '
25900 FOR X=0 TO 9: FOR Y=0 TO 9:ST(X,Y)=0: NEXT Y: NEXT X
25910 ST(2,0)=5:ST(8,0)=5:ST(4,1)=4:ST(0,2)=5:ST(5,2)=5:ST(8,2)=&HF2:ST(3,3)=&HF1:ST(2,5)=5:ST(6,5)=5:ST(8,5)=&HF1:ST(0,6)=&HF1:ST(4,6)=10:ST(7,7)=3:ST(1,8)=5:ST(9,8)=5:ST(4,9)=&H16:NSTX=4:NSTY=6:OSTX=4:OSTY=6
25920 RM(1,0)=3:RM(1,1)=3:RM(2,0)=8:RM(2,1)=5:RM(3,0)=0:RM(3,1)=6:CKC=1:KLC=1:RMC=3
25989 RETURN 
25990 X= FN RAND0(10):Y= FN RAND0(10): RETURN 
25995 '
25997 '
25998 '
25999 '
...
26165 IF ST(XD,YD)>0 THEN 26170 ELSE SDATE!=SDATE!+(9-W)*0.2:OSTX=NSTX:OSTY=NSTY:NSTX=XD:NSTY=YD: GOSUB 20800:A=0: GOSUB 40950: GOSUB 20100: FOR X=1 TO (9-W)*30:A$= INKEY$ : IF A$=" "THEN EXIT=1:X=1000 ELSE IF A$>"" THEN B$=A$
...
27050 XD=XD+X:YD=YD+Y: IF XD<10 AND XD>=0 AND YD<10 AND YD>=0 THEN IF ST(XD,YD)=0 THEN LOCATE 4+YD*2,35+XD*3: COLOR 15,0: PRINT PHS$;: COLOR 7,0: GOTO 27040 ELSE 27058
27055 GOSUB 45200: GOSUB 27400: GOTO 27070
27058 GOSUB 45200: LOCATE 4+YO*2,35+XO*3: PRINT "  ";: GOSUB 20800:S$= CHR$ ( SCREEN (4+YD*2,35+XD*3))+ CHR$ ( SCREEN (4+YD*2,36+XD*3)): LOCATE 4+YD*2,35+XD*3: COLOR 0,7: PRINT S$;: COLOR 7,0: FOR X=1 TO 30: NEXT X: LOCATE 4+YD*2,35+XD*3: PRINT S$;
...
27179 '
27180 LOCATE 4+YD*2,35+XD*3: COLOR 16,7: PRINT RM$: COLOR 15,0: GOSUB 20200: PRINT SP$;RMS$;DST$;: COLOR 7,0:A=(QT(NQTX,NQTY) AND 12)/4:A=A-1:QT(NQTX,NQTY)=(QT(NQTX,NQTY) AND &HF3)+A*4:RM=RM-1:RMC=RMC-1: IF RM(1,0)=XD AND RM(1,1)=YD THEN RM(1,0)=10
...
27279 '
27280 LOCATE 4+YD*2,35+XD*3: COLOR 16,7: PRINT KL$;: COLOR 15,0: GOSUB 20200: PRINT SP$;KLS$;DST$;: COLOR 7,0:A=(QT(NQTX,NQTY) AND 3):A=A-1:QT(NQTX,NQTY)=(QT(NQTX,NQTY) AND &HFC)+A:KL=KL-1:KLC=KLC-1: GOSUB 23600: GOTO 27190
27297 '
27298 ' Hit Starbase
27299 '
27300 LOCATE 4+YD*2,35+XD*3: COLOR 16,7: PRINT BS$;: COLOR 15,0: GOSUB 20200: PRINT "You have killed thousands of your own people, but the microdrone escaped";: COLOR 7,0: GOSUB 23600:QT(NQTX,NQTY)=(QT(NQTX,NQTY) AND &HEF): GOSUB 27190: RETURN 
27397 '
27398 ' No effect hit
27399 '
...
28040 RMMV=27+ FN RAND(4): GOSUB 42000: ON C GOSUB 25701,25702,25703,25704,25705,25706,25707,25708
...
28055 LOCATE 4+YO*2,35+XO*3: PRINT "  ";: GOSUB 20800:A$= CHR$ ( SCREEN (4+YD*2,35+XD*3))+ CHR$ ( SCREEN (4+YD*2,36+XD*3)): LOCATE 4+YD*2,35+XD*3: COLOR 0,7: PRINT A$;: COLOR 7,0:D=1: GOSUB 27160:E=10
...
28398 ' No effect hit
28399 '
28400 GOSUB 20300: PRINT SP$;"Photon torpedo had no effect";: GOSUB 23600: RETURN 
28497 '
28498 ' Hit Star
28499 '
...
28508 ' Supernova
28509 '
28510 COLOR 7,0: GOSUB 20200: PRINT SP$;"This quadrant is becoming a super nova";:KL=KL-(QT(NQTX,NQTY) AND 3):RM=RM-(QT(NQTX,NQTY) AND 12)/4: IF (QT(NQTX,NQTY) AND 32)=32 THEN GOSUB 28680
28515 IF (QT(NQTX,NQTY) AND 64)=64 THEN GOSUB 28690
28517 IF FN L(1)>12 THEN DEAD=1: GOTO 61000
28520 QT(NQTX,NQTY)=128: COLOR 7,0: GOSUB 21000: GOSUB 28700: RETURN 
28525 '
...
28560 COLOR 7,0:B=(ST(XD,YD) AND 15): ON B GOSUB 27180,27280,27300,28590,28580,28680,28590,28690,28590
...
28640 LOCATE 4+YD*2,35+XD*3: COLOR 23,0: PRINT KL$;: COLOR 7,0: GOSUB 45900: GOSUB 20200: PRINT SP$;"Klingon Commander ship disabled";: RETURN 
28650 GOSUB 45900: GOSUB 20200: PRINT SP$;"Klingon Commander ";DMS$;: GOSUB 28660: RETURN 
28657 '
28658 ' Re-locate C. Klingon in same quadrant
28659 '
28660 GOSUB 27190:B=1: WHILE + B=1: GOSUB 25990: IF ST(X,Y)=0 THEN ST(X,Y)=6+P*16:B=0
28670 WEND : COLOR 23,0: LOCATE 4+Y*2,35+X*3: PRINT KL$;: COLOR 7,0: RETURN 
28677 '
28678 ' Relocate C. Klingon in different quadrant
28679 '
28680 QT(NQTX,NQTY)=(QT(NQTX,NQTY) AND &HDF): GOSUB 25990:QT(X,Y)=(QT(X,Y) OR 32):CKC=0:KLX=X:KLY=Y: RETURN 
28687 '
28688 ' Relocate Tholian in different quadrant
28689 '
28690 QT(NQTX,NQTY)=(QT(NQTX,NQTY) AND &HBF): GOSUB 25990:QT(X,Y)=(QT(X,Y) OR 64): RETURN 
28697 '
28698 ' Relocate Enterprise in different quadrant
28699 '
...
29060 RETURN 
29070 '
29080 GOSUB 20300: PRINT "STARBASE to ENTERPRISE:- Orbit established ";: FOR X=500 TO 1100 STEP 20: NEXT X: FOR X=1 TO 2000: NEXT X
29097 '
...
30040 RMMV=27+ FN RAND(4): GOSUB 42000: IF EXIT=1 THEN 30055 ELSE ON C GOSUB 25701,25702,25703,25704,25705,25706,25707,25708
...
30499 '
30500 IF ST(XD,YD)=6 THEN GOSUB 45900: GOSUB 20200: COLOR 15: PRINT SP$;"Klingon Commander ";DST$;: COLOR 7:QT(NQTX,NQTY)=(QT(NQTX,NQTY) AND &HDF):KL=KL-1:KLQ=0:CKC=0: GOTO 30800
30510 GOSUB 28680: GOTO 30800
30597 '
30598 ' Hit Tholian with A.M.
30599 '
30600 GOSUB 45900: GOSUB 20200: COLOR 15: PRINT SP$;THS$;DST$;: COLOR 7:QT(NQTX,NQTY)=(QT(NQTX,NQTY) AND &HBF): GOTO 30800
30697 '
...
40099 '
40100 GOSUB 20300:CURX1= POS (0):CURY1= CSRLIN : ON FIRE GOSUB 41800,41000
40107 '
40108 ' Move Romulan
40109 '
40110 GOSUB 42000
...
40998 ' Klingon fire
40999 '
41000 A=(20+ FN RAND(LEVEL*3))*KLC: GOSUB 24100: IF KLC THEN GOSUB 41880: GOSUB 45300
41047 '
41048 ' Commander Klingon fire
41049 '
41050 IF CKC THEN IF SHP<100 THEN SHP=50:RSP=0 ELSE A=70+ FN RAND(20)+KL*5: GOSUB 24100: GOSUB 41880: GOSUB 44600: GOSUB 45500
41097 '
41098 ' Tholian fire
41099 '
...
41798 ' Romulan fire
41799 '
41800 A=(50+ FN RAND(LEVEL*5))*RMC: GOSUB 24100: IF RMC THEN GOSUB 41880: GOSUB 45400: GOSUB 44600
41860 FIRE=0: RETURN 
41880 GOSUB 20200: PRINT "DAMAGE CONTROL: Enemy attacking - Shields still holding";: RETURN 
41995 '
41996 '*************** Routines called after a date change ********************
41997 '
41998 ' Random move of romulan
41999 '
42000 IF FN RAND(LEVEL)<4 THEN RETURN ELSE IF RMMV<30 THEN RMMV=RMMV+1: RETURN 
...
42040 RETURN 
42100 ON FN RAND(8) GOSUB 25701,25702,25703,25704,25705,25706,25707,25708
42110 RX=RM(R,0):X=RX+X:RX=RM(R,0):RY=RM(R,1):Y=RY+Y:RY=RM(R,1): GOSUB 26900: IF ST(X,Y)=0 THEN ST(X,Y)=ST(RX,RY):RM(R,0)=X:RM(R,1)=Y:ST(RX,RY)=0: LOCATE 4+RY*2,35+RX*3: PRINT "  ";: IF FN RAND(100)<97 THEN LOCATE 4+Y*2,35+X*3: PRINT RM$;
42120 RETURN 
42995 '
42997 '
42999 '
...
43999 '
44000 IF FN RAND(10000)>9997 THEN GOSUB 25990: IF X<>NSTX THEN 44010
44005 GOTO 44100
44010 GOSUB 20200: PRINT SP$;"Quadrant";X;Y;"is becoming a supernova";: LOCATE 4+Y*2,2+X*3: COLOR 0,7: PRINT ST$;: COLOR 7,0
44020 KL=KL-(QT(X,Y) AND 3):RM=RM-(QT(X,Y) AND 12)/4: IF (QT(X,Y) AND 32)=32 THEN KLQ=0:KL=KL-1
44097 '
44098 ' Damage ship
44099 '
44100 IF FN RAND(100)>(100-LEVEL*2) THEN GOSUB 44600
44197 '
44198 ' Terminate life support
44199 '
44200 IF (RSP<1000 AND LSA=0 AND FN RAND(LEVEL)>4 AND FN RAND(1000)>995) THEN LSA=1000:LSPD!=SDATE!+18:LSP=180: COLOR 16,7: GOSUB 20200: PRINT "                LIFE SUPPORT SYSTEM FAILING ";: COLOR 7,0: GOSUB 45700
44500 RETURN 
44597 '
44598 ' Subroutine to damage a part of ship
44599 '
44600 IF RSP>1000 THEN RETURN ELSE A= FN RAND(9):B= FN RAND(LEVEL\2+1): GOSUB 45800: ON A GOSUB 44710,44720,44730,44740,44750,44760,44770,44780,44790
44610 GOSUB 20200: PRINT "DAMAGE CONTROL: ";A$;" inoperative, repair time ";B/10;"stardates";: GOSUB 23600: RETURN 
...
45499 '
45500 IF SOND THEN X=1000: WHILE + X>100:A= FN RAND(100): SOUND A+X,1:X=X-X\21: SOUND 38,0: WEND : RETURN ELSE RETURN 
45597 '
...
49999 '
50000 DEFINT A-Z: PLAY "MB":D$="MLT180O3L2CT60L4BT180L4AL7GL4FL7ET50L2E-T180L4DL2CT60L4O4CO3T180L4B-L7AL4GL7FT50L2ET180L4D#T60L4DT180L4E"
...
50006 DEF SEG=0: IF PEEK (&H109)=&H54 THEN SOND=-1 ELSE SOND=0
...
50040 LOCATE 19,30: COLOR 23,0: PRINT "T r a n s p o r t e r    A c t i v a t e d";: COLOR 7,0
50043 FOR X=0 TO 16 STEP 2
50045 LOCATE X+7,20-X\2: PRINT " €€€";
50050 LOCATE X+8,20-X\2: PRINT "ﬁ€€›";
50060 NEXT X
50085 LOCATE 25,1: PRINT "           €€€";
50090 FOR Y=1 TO 3: FOR A=0 TO 18 : LOCATE 25-A,13+ INT (A/2): PRINT "Ë";: FOR X=1 TO 50: NEXT X: LOCATE 25-A,13+ INT (A/2): PRINT "€";: NEXT A: NEXT Y
50095 FOR A=1 TO 19: LOCATE 26-A,11+ INT (A\2): PRINT "     ";: NEXT A: LOCATE 19,30: PRINT "                                          ";
50097 '
50098 ' Define FN's & DIM's
50099 '
50100 DEF FN RAND (X)= INT ( RND (1)*X+1): DEF FN RAND0 (X)= INT ( RND (1)*X): DEF FN L (X)=LEVEL+ FN RAND(LEVEL)
...
50297 '
50330 KL=0:RM=0: FOR A=9 TO LEVEL STEP -1: GOSUB 25990:QT(X,Y)=16: NEXT A:A=( FN RAND(LEVEL)+5)*7: WHILE + A>0
50335 GOSUB 25990: IF QT(X,Y) > 0 THEN 50335 ELSE X1= FN RAND(LEVEL):X2=X1 AND 3:X3= INT (X1/4):QT(X,Y)=QT(X,Y)+X2
50340 QT(X,Y)=QT(X,Y)+X3*4:A=A-X2-X3:KL=KL+X2:RM=RM+X3: WEND 
50350 KLQ=0: IF FN L(9)>8 THEN KL=KL+1: GOSUB 25990:QT(X,Y)=QT(X,Y)+32:KLQ=1:KLX=X:KLY=Y
50360 IF FN L(9)<9 THEN 50400 ELSE GOSUB 25990: IF (QT(X,Y) AND 32)=32 THEN KLQ=0:KL=KL-1
50370 KL=KL-(QT(X,Y) AND 3):RM=RM-(QT(X,Y) AND 12)/4:QT(X,Y)=64
50397 '
50398 ' Initialize game variables
50399 '
50400 SDATE!=1049.300049: TIME$ ="00:00:00":TIMES=0:TIME=0:EDATE!=SDATE!+RM*9+KL*7
50500 NQTX=5:NQTY=5:OQTX=5:OQTY=5:QT(5,5)=&H3D
50697 '
50997 '
50998 ' Draw screen, initialize secter mat & replenish energy
50999 '
51000 GOSUB 20000: GOSUB 29100: GOSUB 25900: IF (QT(NQTX,NQTY) AND &HEF)>0 THEN GOSUB 45000
51010 GOSUB 21000: GOSUB 22000
51998 ' Initialize Interrupt keys
51999 '
60000 GOTO 1000
60995 '
60998 '
...
61100 COLOR 15,0
61110 FOR A=1 TO 50:X= FN RAND(70):Y= FN RAND(20)
61120 LOCATE Y,X+4: PRINT " ";: LOCATE Y+1,X+2: PRINT "     ";: LOCATE Y+2,X: PRINT "         ";: LOCATE Y+3,X+2: PRINT "     ";: LOCATE Y+4,X+4: PRINT " ";: NEXT A
62000 CHAIN "TREK89",61000.0,ALL
64995 '
64997 '
64998 ' Toggle sound
64999 '
65000 SOUND 32000,0:SOND= NOT SOND: IF SOND THEN DEF SEG=0: POKE &H109,&H54 ELSE DEF SEG=0: POKE &H109,0
65010 RETURN 
65097 '
65098 ' Fatal error trap
65099 '
65100 CLS : IF ERR =71 OR ERR =53 THEN 65200 ELSE PRINT "ERROR "; ERR ;"  AT"; ERL ;" in module TREKDEMO  VER 1.3": PRINT "Please notify Windmill Software": PRINT "Oh wait, they don't exist any more--never mind."
65110 GOTO 65110
