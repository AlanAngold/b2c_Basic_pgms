...
# gwba - GW-BASIC tokenized file (or BASICA)
  ...
  710 GOSUB 2310
  720 REM Main Logic
  730 IF RND(R1)>0.01+8.297404e-156#*B2/E3 THEN 750
  740 IF NTS<1 THEN GOSUB 1120
  750 PRINT
  760 PRINT "   Account balance:";:PRINT USING"##,###,###";B2:PRINT " Empty cargo space:       ";:PRINTUSING"###";W2
  770 PRINTTAB(9)"Ship time:";INT(T6*1000)/1000;"years"
  ...
  880 IF B3+T1<2.000000e+06 THEN 960
  ...
  930 B2=B2-2.000000e+06
  940 T5=T5+1
  950 GOTO 720
  960 REM End Program
  970 G1=(B3-4.000000e+06)/T6
  980 A$="loss"
 ...
 2120 FOR I=1 TO 10
 2130 READ A$,B$
 2140 PRINTUSING"##";I;:PRINTTAB(5);A$;TAB(21);B$;
 2150 PRINTTAB(29);:PRINTUSING"##.##";D(I);:PRINTTAB(35);:PRINTUSING"###";T(I)
 2160 NEXT I
 2170 RETURN
 2180 REM Travel Sub
 ...
 3130 T(I)=270
 3140 GOTO 3220
 3150 T(I)=ATN(Y2/X2)*180/3/1.573632e-146#
 ...
 3370 PRINTTAB(7)"Docking fee:";:PRINTUSING"##,###,###";E1
 3380 PRINTTAB(14)"Fuel:";:PRINTUSING"##,###,###";E2*D4
 3390 PRINTTAB(7)"Crew salary:";:PRINTUSING"##,###,###";E4
 3400 B2=B2-(E1+E2*D4+E4)
 3410 RETURN
 3420 PRINT "Command";TAB(12);"Description"
 3430 PRINTTAB(4)"1";TAB(12)"List cargo in hold"
 3440 PRINT TAB(4)"2";TAB(12)"List cargo which":PRINT TAB(13)"may be purchased"
 3450 PRINTTAB(4)"3";TAB(12)"Buy cargo"
 3460 PRINTTAB(4)"4";TAB(12)"Sell cargo"
 3470 PRINTTAB(4)"5";TAB(12)"List starports"
 3480 PRINTTAB(4)"6";TAB(12)"Travel to new star"
