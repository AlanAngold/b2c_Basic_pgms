...
# gwba - GW-BASIC tokenized file (or BASICA)
  ...
  700 INPUT "DO YOU WISH TO CONTINUE";H$
  720 IF LEFT$(H$,1)="N" OR LEFT$(H$,1)="n" THEN 4100 ELSE 120
  760 IF I<>4 THEN 810
  770 PRINT
  780 PRINT "YOU WIN"
  790 S=S+P
  ...
  810 RETURN
  820 PRINT
  830 INPUT "NOW WE DRAW -- HOW MANY CARDS DO YOU WANT";T
  850 IF T=0 THEN 980
  860 Z=10
  870 IF T<4 THEN 900
 ...
 1720 GOTO 1670
 1730 Z=Z+1
 1740 GOSUB 4200:A(Z)=100*INT(4*RND(1))+INT(100*RND(1))
 ...
 3090 IF K<>0 THEN 3110
 3100 IF G<>0 THEN 3120
 3110 IF T=0.5 THEN 3410
 3120 PRINT "NO SMALL CHANGE, PLEASE":GOTO 3060
 ...
 3540 INPUT "WOULD YOU LIKE TO BUY BACK YOUR WATCH FOR $50";J$
 3560 IF LEFT$(J$,1)="N" OR LEFT$(J$,1)="n" THEN 3600
 3570 C=C+50
 3580 O=O/2
 3590 RETURN
 3600 IF O/3<>INT(O/3) THEN 3670
 3610 3610 INPUT "WOULD YOU LIKE TO BUY BACK YOUR TIE TACK FOR $50";J$
 ...
 3860 INPUT "WOULD YOU LIKE TO SELL YOUR WATCH";J$
 3880 IF J$="NO" OR J$="no" THEN 3970
 ...
 3980 3980 INPUT "WILL YOU PART WITH THAT DIAMOND TIE TACK";J$
 4000 IF J$="no" OR J$="NO" THEN 4080
 ...
 4100 END
 4200 RANDOMIZE(VAL(RIGHT$(TIME$,2))):RETURN
