...
# gwba - GW-BASIC tokenized file (or BASICA)
    ...
    4 PRINTTAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
    6 PRINT:PRINT:PRINT
 ...
 1010 D(1)=100*INT((M1*(100-I1)/2000)*(1+(R1-Q1)/(R1+1))+0.5)
 1020 D(2)=100*INT(M2*(100-I2)/2000+0.5)
 1030 IF LEFT$(B$,1)<>"y" THEN 1050
 1040 D(2)=100*INT(((M2*(100-I2)/2000)*(1+R2-Q2)/(R2+1))+0.5)
 1045 IF D(2)<=0 THEN BEEP:D(2)=100*INT((M2*(100-I1)/2000)*(1+(R1-Q1)/(R1+1))+0.5)
 ...
 2210 C5=INT(C5*(1+1/O)*(1.28+F1/(B(1)+1))+0.5)
 2220 E=100/O
 ...
 2330 PRINT "Confederate:";STR$(INT(100*(C5/C1)+0.5));"% of the original."
 2340 PRINT "Union:      ";STR$(INT(100*(C6/C2)+0.5));"% of the original."
 2350 PRINT
 2360 REM - 1 WHO ONE
 ...
 2510 E2=5*O
 2520 GOTO 2280
 2530 PRINT "Your casualties were";STR$(INT(100*(C5/C1)+0.5));"% of"
 ...
 3000 PRINT "Historical Losses",INT(P1+0.5),INT(P2+0.5)
 3010 PRINT "Simulated Losses",INT(T1+0.5),INT(T2+0.5)
 3020 PRINT
 3030 PRINT "    % of Original",INT(100*(T1/P1)+0.5),INT(100*(T2/P2)+0.5)
