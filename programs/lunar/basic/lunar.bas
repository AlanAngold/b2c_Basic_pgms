...
# gwba - GW-BASIC tokenized file (or BASICA)
  ...
  140 A=120:V=1:M=33000.0:N=16500:G=0.001:Z=1.8
  150 PRINTL,INT(A);INT(5280*(A-INT(A))),3600*V,M-N,:INPUT K:T=10
  ...
  310 PRINT "In fact, you blasted out a new Lunar crater";W*0.277;"feet deep!"
  320 GOTO 440
