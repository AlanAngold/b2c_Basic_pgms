...
# gwba - GW-BASIC tokenized file (or BASICA)
  ...
  340 B5=B3/100
  350 B6=5280*0.3048
  360 B7=6.670000e-11*5.983000e+24
  370 B8=ATN(1)/45
  380 B9=90
  390 C=1
  400 C0=SQR(B7/9.80665)
  410 C1=C0
  420 C2=SQR(B7/(C0+B6*A8))/0.3048
  430 C3=0
  440 C4=0
  450 C5=0
  460 C6=0
 ...
 1260 G2=D8/(D4+D7)/0.3048
 1270 G3=G2*15/22
 1280 G4=G2-(G1/0.3048)
 1290 G5=G4*15/22
 1300 G6=G1/0.3048/G2
 1310 G7=100*G6
 1320 G8=90
 1330 IF G6=>1 THEN 1350
 1340 G8=ATN(G6/SQR(1-G6*2))/B8
 1350 G9=SQR(ABS(B7/C1))/0.3048
 1360 H=100*F8/C2
 ...
 1430 IF H4<=9999.990234 THEN 1460
 1440 H4=9999.990234
 ...
 1890 H6=INT(SQR(F6*2+F8*2)+0.5)
 1900 H7=INT(SQR(F7*2+F9*2)+0.5)
