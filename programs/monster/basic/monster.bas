...
# gwba - GW-BASIC tokenized file (or BASICA)
  ...
  510 IF I=2 THEN PRINT "COMBAT STRENGTH:";:PRINTTAB(40);C
  520 IF I=3 THEN PRINT "TREASURE TOTAL:";:PRINTTAB(40);Q
  530 IF I=4 THEN PRINT "MAGIC:"
  540 IF I=5 THEN PRINT " SLEEP SPELLS:";:PRINTTAB(40);S
  550 IF I=6 THEN PRINT " CHARMS:";:PRINTTAB(40);R
  560 IF I=7 THEN PRINT " INVISIBILITY:";:PRINTTAB(40);V
  570 IF I=9 THEN PRINT "DAYS IN FOREST:";:PRINTTAB(40);D1
  ...
  850 GOSUB 3500:I=INT(RND(1)*1001):L=2:C=C-K:K=K-0.01*Q
  ...
  970 A=X:B=Y:K=0:T=0:GOSUB 3500:C=C-INT((RND(1)*21)+0.001*Q)-5
  980 GOSUB 3500:X=A+INT(RND(1)*3)-1:GOSUB 3500:Y=B+INT(RND(1)*3)-1
  990 IF X=A AND Y=B THEN 980
 1000 DA=DA+0.1:IF X>10 THEN X=1:X1=X1+1:K=1
 ...
 1110 J=(P+(M+0.1))*N1:IF K<2 THEN 1140
 1120 FOR H=0 TO 20:IF K<=J*L AND I=>H THEN 1140
 1130 L=L+0.1:NEXT H:GOTO 1160
 ...
 1490 GOSUB 3500:C=C-INT(RND(1)*Q*0.005)-25:X=A:Y=B:GOTO 1270
 ...
 1530 GOSUB 3500:I=INT(RND(1)*Q*0.75):IF I<5 AND Q>5 THEN I=5
 ...
 2080 PRINT "YOU FELL INTO A PIT.":I=INT((RND(1)*21)+0.001*Q):C=C-I
 ...
 2380 FOR I=1 TO 5:PRINTM$(I);TAB(14);N(I);TAB(32);M$(I+5);TAB(46);N(I+5)
 2400 NEXT I:PRINT TAB(32);M$(11),TAB(46);N(11)
 2410 PRINT:PRINT "BRIBED:";BR;TAB(32)"RAN FROM";Z
 2420 PRINTTAB(10)"TREASURE TOTAL: ";Q
 ...
 2830 D1=D1+I:RETURN
 2840 GOSUB 3500:I=INT(RND(1)*10+1):J=D1:D1=D1-I:IF D1<0.1 THEN D1=0.1:I=J-D1
