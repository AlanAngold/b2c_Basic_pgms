...
# gwba - GW-BASIC tokenized file (or BASICA)
    1 CLS:PRINTTAB(20);"MAN-EATING RABBIT"
    2 PRINTTAB(20);"Creative Computing"
    3 PRINTTAB(18);"Morristown, New Jersey"
    4 PRINT:PRINT:PRINT
   ...
   25 PRINT "released.  You and the rabbit can move only 1 space"
   26 PRINT "each.  However, the rabbit can do multiple jumps."
   27 PRINT "You can travel at these angles:"
   28 PRINT "0,45,90,135,180,225,270,315,360"
   40 RANDOMIZE(VAL(RIGHT$(TIME$,2)))
   41 X=INT(21*(RND*1)-10)
   42 Y=INT(21*(RND*1)-10)
  ...
  126 PRINT "You can't go into a wall!":GOTO 100
  ...
  138 PRINT "You ran right into the rabbit!!":GOTO 330
