...
2 PRINT TAB(34);"DICE":PRINT
4 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
6 PRINT:PRINT:PRINT
10 DIM F(12)
20 REM  DANNY FREIDUS
30 PRINT "THIS PROGRAM SIMULATES THE ROLLING OF A PAIR OF DICE."
...
195 PRINT "-----------","---------------":PRINT
200 FOR V=2 TO 12
210 PRINT TAB(5);:PRINT USING "##";V;:PRINT "",:PRINT USING "#,###,###";
    F(V)
220 NEXT V
221 PRINT
222 PRINT:PRINT "TRY AGAIN";
223 INPUT Z$
224 IF LEFT$(Z$,1)="Y" THEN 80
240 RUN "MENU"
