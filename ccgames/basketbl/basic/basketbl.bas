...
5 PRINT TAB(31);"BASKETBALL":PRINT
7 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
8 PRINT:PRINT:PRINT
10 PRINT "THIS IS PRINCETON COLLEGE BASKETBALL.  YOU WILL BE PRINCETON"
20 PRINT "CAPTAIN AND PLAYMAKER.  CALL SHOTS AS FOLLOWS:  1. LONG"
30 PRINT "(30 FT.) JUMP SHOT; 2. SHORT (15 FT.) JUMP SHOT; 3. LAY UP;"
40 PRINT "4. SET SHOT.":PRINT
60 PRINT "BOTH TEAMS WILL USE THE SAME DEFENSE.  CALL DEFENSE AS"
70 PRINT "FOLLOWS:  6. PRESS; 6.5 MAN-TO MAN; 7. ZONE; 7.5 NONE."
72 PRINT "TO CHANGE DEFENSE, JUST TYPE 0 AS YOUR NEXT SHOT.":PRINT
...
410 GOTO 3000
420 PRINT "PRINCETON CONTROLS THE TAP."
425 PRINT
...
494 PRINT "        PRINCETON:";S(1);"  ";O$;":";S(0)
495 PRINT
496 PRINT "BEGIN TWO MINUTE OVERTIME PERIOD"
499 T=93
500 GOTO 370
510 PRINT "   ***** END OF GAME *****"
515 PRINT "FINAL SCORE: PRINCETON:";S(1);"  ";O$;":";S(0)
520 RUN "MENU"
600 PRINT
...
1110 PRINT "PRINCETON CONTROLS THE REBOUND."
1120 GOTO 1145
...
1260 GOSUB 4000
1265 GOTO 3000
1270 PRINT "CHARGING FOUL.  PRINCETON LOSES BALL."
1280 GOTO 3000
1300 T=T+1
...
1400 GOTO 3000
1415 PRINT "PRINCETON CONTROLS THE REBOUND."
...
1620 GOTO 3000
1630 PRINT "CHARGING FOUL.  PRINCETON LOSES THE BALL."
1640 GOTO 3000
1700 PRINT "SET SHOT."
1710 GOTO 1330
...
3120 PRINT "PRINCETON CONTROLS THE REBOUND."
3130 GOTO 425
...
3220 GOSUB 4000
3230 GOTO 425
3310 PRINT "OFFENSIVE FOUL.  PRINCETON'S BALL."
3320 GOTO 425
...
5005 GOTO 3165
5010 PRINT "BALL STOLEN.  EASY LAY UP FOR PRINCETON."
5015 GOSUB 7000
5030 GOTO 3000
...
8010 PRINT "SCORE: PRINCETON:";S(1);"  ";O$;":";S(0)
8015 PRINT
8016 PRINT
8020 GOTO 370
9999 RUN "MENU"
