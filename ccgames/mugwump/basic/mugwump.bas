0 RANDOMIZE
1 PRINT CHR$(26):WIDTH 80:PRINT TAB(33);"MUGWUMP":PRINT
...
70 PRINT "IS DISTANCE ABOVE HOMEBASE. ENTER THE TWO NUMBERS ""
75 PRINT "SEPARATED BY A COMMA."
80 PRINT
...
300 INPUT M,N
302 PRINT
305 IF M<0 OR M>9 OR N<0 OR N>9 THEN 
    PRINT "THE NUMBERS MUST BE BETWEEN 0 AND 9.":PRINT:GOTO 290
310 FOR I=1 TO 4
320 IF P(I,1)=-1 THEN 400
330 IF P(I,1)<>M THEN 380
340 IF P(I,2)<>N THEN 380
350 P(I,1)=-1
360 PRINT "YOU HAVE FOUND MUGWUMP";I;CHR$(8);"."
370 GOTO 400
380 D=SQR((P(I,1)-M)^2+(P(I,2)-N)^2)
390 PRINT "YOU ARE ";:PRINT USING "##.#";(INT(D*10))/10;:
    PRINT " UNITS FROM MUGWUMP";I;CHR$(8);"."
400 NEXT I
410 FOR J=1 TO 4
...
570 NEXT I
580 PRINT
600 LINE INPUT "THAT WAS FUN! DO YOU WANT TO PLAY AGAIN? ";XX$
602 IF LEFT$(XX$,1)="N" THEN 1099
