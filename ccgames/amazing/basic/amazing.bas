5 WIDTH 80:PRINT CHR$(26)
10 PRINT TAB(28);"AMAZING PROGRAM"
12 PRINT:PRINT
20 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
30 PRINT:PRINT:PRINT
40 PRINT "   THIS PROGRAM GENERATES MAZES OF DIMENSIONS YOU SPECIFY."
42 PRINT "EVERY MAZE IS DIFFERENT, AND HAS ONLY ONE WAY THROUGH. THE"
44 PRINT "MAZE APPEARS ON THE TERMINAL CRT SCREEN. IF YOU WANT A PRINTED"
46 PRINT "MAZE, RUN THE 'AMAZINGP' PROGRAM INSTEAD OF THIS ONE.":PRINT:PRINT
100 INPUT 
    "WHAT ARE YOUR WIDTH AND LENGTH (TWO NUMBERS SEPARATED BY A COMMA)";H,V
101 IF H>26 OR V>10 THEN PRINT: 
    PRINT "MAZE WILL NOT FIT ON SCREEN. MAXIMUM WIDTH IS 25;":
    PRINT "MAXIMUM LENGTH IS 10. TRY AGAIN.":PRINT:PRINT:GOTO 100
102 IF H<>1 AND V<>1 THEN 110
104 PRINT:PRINT "MEANINGLESS DIMENSIONS.  TRY AGAIN.":PRINT:PRINT:GOTO 100
110 DIM W(H,V),V(H,V)
120 PRINT
130 PRINT
140 PRINT
