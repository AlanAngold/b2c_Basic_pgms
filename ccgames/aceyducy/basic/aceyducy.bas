...
10 PRINT TAB(26);"ACEY DUCEY CARD GAME":PRINT:PRINT
20 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
21 PRINT
22 PRINT
30 PRINT TAB(15);"ACEY-DUCEY IS PLAYED IN THE FOLLOWING MANNER: ":PRINT
40 PRINT TAB(15);"THE DEALER (COMPUTER) DEALS TWO CARDS FACE UP."
50 PRINT TAB(15);"YOU HAVE AN OPTION TO BET OR NOT BET DEPENDING"
60 PRINT TAB(15);"ON WHETHER OR NOT YOU FEEL THE CARD WILL HAVE"
70 PRINT TAB(15);"A VALUE BETWEEN THE FIRST TWO.":PRINT
80 PRINT TAB(15);"IF YOU DO NOT WANT TO BET, INPUT A 0"
90 PRINT:PRINT
100 N=100
110 Q=100
