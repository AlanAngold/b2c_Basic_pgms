...
205 PRINT:PRINT
210 PRINT "I AM THINKING OF A WHOLE NUMBER FROM 1 TO";A;CHR$(8);"."
...
550 PRINT 
560 PRINT "SORRY, THAT'S";M;"GUESSES. THE NUMBER WAS";X;CHR$(8);"."
580 GOTO 650
...
620 NEXT N
630 PRINT:PRINT
640 PRINT "YOU GOT IT IN";K;"GUESSES!!!"
650 PRINT:INPUT "PLAY AGAIN";X$
660 IF LEFT$(X$,1)="Y" THEN 280 ELSE RUN "MENU"
