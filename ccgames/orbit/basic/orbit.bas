...
70 PRINT:PRINT
72 LINE INPUT "ENTER 'RETURN' TO CONTINUE.";RESP$:PRINT CHR$(26)
...
112 PRINT:PRINT
113 LINE INPUT "ENTER 'RETURN' TO CONTINUE.";RESP$:PRINT CHR$(26)
114 PRINT
115 PRINT "BELOW IS A DIAGRAM TO HELP YOU VISUALIZE YOUR PLIGHT."
116 PRINT "X = YOUR PLANET; 0 = THE ORBIT OF THE ROMULAN SHIP."
117 PRINT
168 PRINT "                          90"
...
190 PRINT "                         270";TAB(40);:LINE INPUT
    "ENTER 'RETURN' TO CONTINUE.";RESP$:PRINT CHR$(26)
...
325 PRINT
326 PRINT
330 PRINT "THIS IS HOUR";H;CHR$(8);". AT WHAT ANGLE DO YOU WISH TO SEND"
...
460 GOTO 310
470 PRINT:PRINT "YOU HAVE SUCCESFULLY COMPLETED YOUR MISSION.":PRINT
480 GOTO 500
490 PRINT:PRINT "YOU HAVE ALLOWED THE ROMULANS TO ESCAPE.":PRINT
500 PRINT "ANOTHER ROMULAN SHIP HAS GONE INTO ORBIT."
510 PRINT "DO YOU WISH TO TRY TO DESTROY IT";
520 INPUT C$
530 IF LEFT$(C$,1)="Y" THEN PRINT CHR$(26):GOTO 270 ELSE PRINT
540 PRINT "GOOD BYE."
999 RUN "MENU"
