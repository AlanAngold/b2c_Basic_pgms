...
10 PRINT TAB(33);"BUNNY":PRINT
20 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
30 PRINT: PRINT: PRINT
40 PRINT "MAKE SURE THE PRINTER IS ON."
50 LINE INPUT "ENTER 'RETURN' WHEN THE PRINTER AND PAPER ARE READY. ";XX$
...
180 LPRINT TAB(X);: READ Y
190 FOR I=X TO Y: J=I-5*INT(I/5)
200 LPRINT CHR$(L+B(J));
210 NEXT I
220 GOTO 170
230 REM
240 GOSUB 260: GOTO 450
250 REM
260 FOR I=1 TO 6: LPRINT CHR$(10);: NEXT I
270 RETURN
280 REM
