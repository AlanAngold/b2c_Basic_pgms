0 RANDOMIZE
1 PRINT CHR$(26):WIDTH 80:PRINT TAB(28);"RUSSIAN ROULETTE":PRINT
...
22 PRINT "TYPE '2' TO GIVE UP.":PRINT:PRINT
23 PRINT "GO:":PRINT "==":PRINT
25 N=0
30 INPUT I
31 IF I<>2 THEN 35
32 PRINT "     CHICKEN!!!!!"
...
75 INPUT "ANOTHER VICTIM";X$:IF LEFT$(X$,1)="Y" THEN 20 ELSE RUN "MENU"
80 PRINT "YOU WIN!!!!!"
