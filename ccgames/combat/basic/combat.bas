1 PRINT CHR$(26):WIDTH 80:PRINT TAB(33);"COMBAT":PRINT
2 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
3 PRINT: PRINT: PRINT: F$="###,##"
4 PRINT "I AM AT WAR WITH YOU.": PRINT "WE HAVE 72,000 SOLDIERS APIECE."
5 PRINT:PRINT "DISTRIBUTE YOUR FORCES.":PRINT:PRINT
6 PRINT ,"   ME","  YOU":PRINT ,"--------","--------"
7 PRINT "ARMY"," 30,000",
8 INPUT A
9 PRINT "NAVY"," 20,000",
10 INPUT B
11 PRINT "AIR FORCE"," 22,000",
12 INPUT C
13 IF A+B+C>72000! THEN PRINT:PRINT "YOU ONLY HAVE 72,000 MEN.":GOTO 5
14 D=30000
15 E=20000
16 F=22000
17 PRINT:PRINT "YOU ATTACK FIRST. TYPE (1) FOR ARMY; (2) FOR NAVY;"
...
115 GOTO 270
120 PRINT "YOU LOST";:PRINT USING F$;X;:PRINT "MEN FROM YOUR ARMY."
125 A=INT(A-X)
130 GOTO 500
150 PRINT:PRINT "YOU LOST";:PRINT USING F$;INT(X/3);:
    PRINT " MEN, BUT I LOST ";:PRINT USING F$;INT(2*D/3);:PRINT "."
155 A=INT(A-X/3)
160 D=0
165 GOTO 500 
200 IF X>B THEN 20
...
232 B=INT(B-X)
235 GOTO 500
250 PRINT "YOU DESTROYED";:PRINT USING F$;INT(2*E/3);:PRINT "OF MY ARMY."
255 E=INT(E/3)
260 GOTO 500
...
390 D=INT(2*D/3)
500 PRINT
501 PRINT,"  YOU  ","  ME":PRINT,"------","------"
510 PRINT "ARMY",:PRINT USING F$;A;:PRINT"",:PRINT USING F$;D
520 PRINT "NAVY",:PRINT USING F$;B;:PRINT"",:PRINT USING F$;E
530 PRINT "AIR FORCE",:PRINT USING F$;C;:PRINT "",:PRINT USING F$;F
1000 PRINT:PRINT "WHAT IS YOUR NEXT MOVE?":PRINT
