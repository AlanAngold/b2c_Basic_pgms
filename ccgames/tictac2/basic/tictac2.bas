...
2 PRINT TAB(30);"TIC-TAC-TOE":PRINT
...
2000 PRINT:INPUT "PLAY AGAIN";ANS$
2005 PRINT:PRINT:PRINT
2010 IF LEFT$(ANS$,1)="Y" THEN FOR I=1 TO 9:S(I)=0:NEXT:GOTO 50 ELSE RUN "MENU"
