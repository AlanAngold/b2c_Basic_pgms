1 PRINT CHR$(26);TAB(34);"GOLF":PRINT
...
7 PRINT "COMMENTATOR WILL EXPLAIN THE GAME AS YOU PLAY.":PRINT
...
260 K=0
270 IF F=1 THEN 310
290 PRINT "YOUR SCORE ON HOLE";F-1;"WAS";S1;CHR$(8);"."
291 GOTO 1750
...
1595 PRINT
1600 PRINT "YOU ARE AT THE TEE OF HOLE NUMBER";F;"-- PAR";P;CHR$(8);
     ",";D;"YARDS."
1605 G3=G3+P
...
1710 PRINT
1750 G2=G2+S1
1760 PRINT "TOTAL PAR FOR";F-1;"HOLES IS";G3;CHR$(8);
     ". YOUR TOTAL IS";G2;
1761 IF G3=G2 THEN PRINT "( EVEN PAR )."
1762 IF G3>G2 THEN PRINT "(";(G3-G2);"UNDER PAR )."
1763 IF G3<G2 THEN PRINT "(";(G2-G3);"OVER PAR )."
1768 IF G1=F-1 THEN 1770
1769 GOTO 292
1770 RUN "MENU"
