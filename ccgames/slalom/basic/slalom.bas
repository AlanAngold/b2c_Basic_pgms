...
390 PRINT "TRY AGAIN,"
400 GOTO 310
410 PRINT:PRINT "RATE YOURSELF AS A SKIER, (1=WORST, 3=BEST)";
420 INPUT A
430 IF A<1 THEN 460
440 IF A>3 THEN 460
450 GOTO 480
...
470 GOTO 410
480 PRINT:PRINT"THE STARTER COUNTS DOWN";
481 FOR I=5 TO 1 STEP -1:FOR J=1 TO 400:NEXT J
482 PRINT"...";:PRINT USING"#";I;:NEXT I
483 FOR J=1 TO 400:NEXT J
484 PRINT"...GO!"
490 REM
500 LET T=0
...
750 INPUT B$
760 REM
770 IF LEFT$(B$,1)="N" THEN 1740
780 IF LEFT$(B$,1)="Y" THEN 480
...
1470 PRINT:PRINT "COMMAND--";
1480 INPUT A$
1490 REM
1500 IF LEFT$(A$,1)="I" THEN 820
1510 IF LEFT$(A$,1)="M" THEN 1550
1520 IF LEFT$(A$,1)="R" THEN 410
