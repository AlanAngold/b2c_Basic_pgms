1 PRINT CHR$(26);TAB(31);"EVEN WINS"
...
280 M1=M1+M
290 T=T-M
300 IF M=1 THEN PRINT "I PICK UP 1 MARBLE." ELSE PRINT "I PICK UP";M;"MARBLES."
310 IF T=0 THEN 880
320 PRINT:PRINT "TOTAL=";T:PRINT
330 PRINT
340 PRINT "WHAT IS YOUR NEXT MOVE (MY TOTAL IS";M1;CHR$(8);")";
350 INPUT Y
360 PRINT
...
460 PRINT "TOTAL=";T
470 PRINT
480 PRINT "YOUR TOTAL IS";Y1;CHR$(8);"."
490 IF T<.5 THEN 880
500 R=T-6*INT(T/6)
...
800 IF M=1 THEN PRINT "I PICK UP 1 MARBLE." ELSE PRINT "I PICK UP";M;"MARBLES."
810 PRINT
820 GOTO 880
830 REM    THIS IS WHERE I WIN
840 IF M=1 THEN PRINT "I PICK UP 1 MARBLE." ELSE PRINT "I PICK UP";M;"MARBLES."
850 PRINT
860 PRINT "TOTAL = 0"
870 M1=M1+M
880 PRINT "THAT IS ALL OF THE MARBLES."
890 PRINT
900 PRINT " MY TOTAL IS";M1;CHR$(8);", YOUR TOTAL IS";Y1;CHR$(8);"."
910 PRINT
920 IF INT(M1/2)=M1/2 THEN 950
930 PRINT "     YOU WON.  DO YOU WANT TO PLAY";
940 GOTO 960
950 PRINT "     I WON.  DO YOU WANT TO PLAY";
960 INPUT " AGAIN";A1$:PRINT:PRINT
980 IF LEFT$(A1$,1)="N" THEN 1030
990 M1=0
1000 Y1=0
1010 GOTO 200
1020 GOTO 640
