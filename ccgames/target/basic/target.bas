...
190 PRINT "DESTROYED!": PRINT: PRINT "TO QUIT, ENTER 0,0,0.":PRINT: 
    PRINT "GOOD LUCK!!": PRINT: PRINT
220 A=RND(1)*2*P: B=RND(1)*2*P: Q=INT(A*R1): W=INT(B*R1)
250 PRINT "TARGET SIGHTED.":PRINT
260 PRINT "RADIANS FROM X AXIS =";A;"   FROM Z AXIS =";B
280 P1=100000!*RND(1)+RND(1): X=SIN(B)*COS(A)*P1: Y=SIN(B)*SIN(A)*P1
290 Z=COS(B)*P1
340 PRINT "APPROXIMATE COORDINATES:  X =";X;"  Y =";Y;"  Z =";Z
...
405 INPUT A1,B1,P2
406 IF A1=0 AND B1=0 AND P2=0 THEN PRINT:PRINT "QUITTERS DIE IN SPACE!!!":
    PRINT: RUN "MENU"
