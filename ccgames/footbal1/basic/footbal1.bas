...
10 PRINT TAB(33);"FOOTBALL":PRINT
...
260 PRINT
270 LINE INPUT "CHOOSE YOUR OPPONENT: ";O$(1):PRINT
290 O$(0)="DARTMOUTH"
300 PRINT
...
480 INPUT A$
485 IF LEFT$(A$,1)="K" THEN A$="KICK" ELSE IF LEFT$(A$,1)="R" THEN A$="RECEIVE"
    ELSE GOTO 470
490 PRINT
500 FOR E=1 TO 2
...
910 PRINT:PRINT "***  END OF GAME  ***":PRINT
...
1830 GOTO 2710
1840 PRINT:PRINT "***  FIELD GOAL  ***":PRINT
1850 LET S(P)=S(P)+3
1860 GOTO 2640
...
2930 INPUT A$
2940 IF LEFT$(A$,1)="N" THEN 2300
2950 IF LEFT$(A$,1)="Y" THEN 3110
