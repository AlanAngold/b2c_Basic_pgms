...
# trs2 - TRS-80 Level II BASIC tokenized file
  ...
  100 IF CT > MAX PRINT "THAT WILL TAKE SOME TIME AND FIRST YOU WILL<ERROR>HAVE TO  CHANGE LINE 50" : END 
  110 IF CT < = 0 PRINT "SORRY, THAT'S NOT POSSIBLE" : GOTO 90
  120 IF CT < = 3 PRINT "YOU HAVE NO SENSE OF ADVENTURE - BUT I SUPPOSE<ERROR>YOU HAVE TO START SOMEWHERE"
  130 N(1) = CT : N(2) = 0 : N(3) = 0
  140 IF AN$ = "YES" OR AN$ = "NO" THEN PRINT "TYPE 'A' IF YOU WANT ME TO DO ALL THE WORK (I.E. AUTOMATIC <ERROR>OPERATION)  OTHERWISE TYPE 'M' FOR MANUAL OPERATION" : PRINT "WHICH WOULD YOU LIKE ";
  ...
  350 IF N(F) < = 0 PRINT "THERE ARE NO DISCS ON PEG ";F : GOTO 300
  360 I = N(F) : J = N(T)
  ...
  440 IF T1 > T2 PRINT "NOT ALLOWED" : GOTO 300
  ...
  490 IF NM = M THEN PRINT "CONGRATULATIONS! YOU DID IT" : ELSE IF NM - M < = M * 0.15 THEN PRINT "NOT BAD AT ALL"
  500 PRINT "YOU TRANSFERRED ALL THE DISCS IN ";NM;" MOVES
  510 PRINT "CARE FOR ANOTHER GAME (YES OR NO)";
  520 INPUT AN$
  530 IF AN$ = "N" OR AN$ = "NO" THEN CLS : END : ELSE GOTO 80
  540 J = CT
  550 FOR I = 1 TO CT
