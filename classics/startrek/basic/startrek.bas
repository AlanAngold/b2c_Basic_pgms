...
# trs2 - TRS-80 Level II BASIC tokenized file
 ...
 1680 REM 
 1685 IF P < 0 PRINT "ALL PHOTON TORPEDOES EXPENDED." : GOTO 590
 1690 IF D(5) < 0 THEN PRINT "PHOTON TUBES ARE NOT OPERATIONAL" : GOTO 590
 1700 INPUT "PHOTON TORPEDO COURSE (1-9)";C1 : IF C1 = 9 THEN C1
 ...
 2090 D3 = 0 : FOTI = 1 TO 8 : IF D(I) < 0 THEN D3 = D3 + .1
 ...
 2160 FOR I = 1 TO 8 : IHD(I) < 0 THEN D(I) = 0
 ...
 2700 H8 = 1 ELSE A + 1 GOTO 2810,2930,3010,3270,3070
