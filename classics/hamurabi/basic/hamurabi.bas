...
# trs2 - TRS-80 Level II BASIC tokenized file
 ...
 1020 IF C = 1 THEN 1035
 1030 PRINT C;"PEOPLE STARVED, AND"; : GOTO 1040
 1035 PRINT " 1 PERSON STARVED, AND";
 1040 IF B = 1 THEN 1048
 1045 PRINT B;"PEOPLE CAME TO THE CITY." : GOTO 1050
 ...
 1310 INPUT "      BUY HOW MANY ACRES";I : I = INT ( ABS (I)) : IF I = 0 THEN 1500
 1360 J = I * K : IF J < = D THEN 1400
 1380 GOSUB 9000 : GOTO 1310
 1400 D = D - J : H = H + I
 1500 PRINT @576,"   *  YOU ARE BUYING";I;"ACRES.                         "
 1505 IF I > 0 THEN 1650
 1510 PRINT @640,"  "
 1520 PRINT @704,"  "
 1530 Q = 640 : PRINT @Q,"";
 1540 INPUT "      SELL HOW MANY ACRES";I : I = INT ( ABS (I)) : IF I = 0 THEN 1570
 1550 IF I < H THEN 1570
 1560 IF I = H THEN 9999
 1565 GOSUB 9000 : GOTO 1540
 ...
 1710 I = INT ( ABS (I))
 1740 IF I < = D THEN 1770
 1750 GOSUB 9000 : GOTO 1700
 1770 D = D - I : C = A - INT (I / 20) : B = 0 : IF C > = 0 THEN 1850
 1810 B = - C / 2 : C = 0
 1850 Q = P * 64 + 704
 ...
 1910 IF I > H THEN 1960
 1940 J = INT (I / 2) : IF J < = D THEN 1980
 1960 GOSUB 9000 : GOTO 1900
 1980 IF I > 10 * A THEN 1960
 1985 CLS 
 1990 D = D - J : F = RND (5) : G = F * I : E = INT ((D + G) * .07 * RND (0)) : D = D - E + G : J = RND (11) - 1
 2060 B = INT (B + (5 - F) * D / 600 + 1) : IF B < = 50 THEN 2100
 2080 B = 50
 2100 IF B < 0 THEN B = 0
 2110 A = A + B - C : L = L + 1 : GOTO 1010
 9000 PRINT @Q + 128,"                                                     ";
 9001 PRINT "    ";
 9010 PRINT @Q,"";
...
10001 PRINT : PRINT "BYE" : FOR T = 1 TO 9999 : NEXT T : CLS : END 
