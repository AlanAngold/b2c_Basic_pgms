1 PRINT CHR$(26):WIDTH 80:PRINT TAB(33);"QUEEN":PRINT
...
23 IF LEFT$(W$,1)="N" THEN 30
24 IF LEFT$(W$,1)="Y" THEN 28
...
180 GOTO 100
200 GOSUB 2000
210 PRINT "COMPUTER MOVES TO SQUARE";M;CHR$(8);"."
...
4010 INPUT Q$
4020 PRINT
4030 IF LEFT$(Q$,1)="Y" THEN 30 
4040 IF LEFT$(Q$,1)="N" THEN 4050
4042 PRINT "PLEASE ANSWER 'YES' OR 'NO'."
4045 GOTO 4000
4050 PRINT:PRINT "OK --- THANKS AGAIN.":PRINT
4060 RUN "MENU"
4990 REM     DIRECTIONS
5000 PRINT CHR$(26):
...
5140 PRINT
5150 LINE INPUT "ENTER 'RETURN' TO START THE GAME. ";RESP$
5160 PRINT CHR$(26)
5170 FOR A=0 TO 7
5180 FOR B=1 TO 8
5185 I=8*A+B
5190 PRINT USING "###  ";S(I);
5200 NEXT B
5210 PRINT
5240 NEXT A
5250 PRINT
