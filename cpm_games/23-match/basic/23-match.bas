1 RANDOMIZE
10 PRINT CHR$(26):WIDTH 80
20 PRINT TAB(31);"23 MATCHES":PRINT
...
260 N = N -2
270 PRINT "THE NUMBER OF MATCHES IS NOW" N;CHR$(8);"."
280 PRINT
...
330 IF K <= 0 THEN 430
340 N = N - K
350 PRINT "THERE ARE NOW";N;"MATCHES REMAINING.":PRINT
351 IF N = 4 THEN 381
352 IF N = 3 THEN 383
353 IF N = 2 THEN 385
360 IF N <= 1 THEN  530
...
384 GOTO 390
385 Z = 1
390 PRINT "MY TURN. I REMOVE";Z;:IF Z=1 THEN PRINT "MATCH." 
    ELSE PRINT "MATCHES."
400 N = N - Z
410 IF N < = 1 THEN 470
420 GOTO 270
...
552 PRINT:PRINT
555 INPUT "DO YOU WANT TO TRY AGAIN";ANS$
556 IF LEFT$(ANS$,1)="Y" THEN PRINT CHR$(26):GOTO 140
560 RUN "MENU"
570 END
