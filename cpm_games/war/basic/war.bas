...
10 PRINT TAB(33);"WAR":PRINT
20 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
30 PRINT: PRINT: PRINT
100 PRINT "THIS IS THE CARD GAME OF WAR."
105 PRINT:PRINT "EACH CARD IS INDICATED BY ITS SUIT AND RANK,"
110 PRINT "SUCH AS 'S-7' FOR THE SEVEN OF SPADES."
115 PRINT
120 PRINT "DO YOU WANT DIRECTIONS";
130 INPUT B$
135 PRINT
140 IF LEFT$(B$,1)="N" THEN 210
150 IF LEFT$(B$,1)="Y" THEN 180
...
205 PRINT:PRINT
210 PRINT "PLEASE STAND BY WHILE I SHUFFLE THE DECK......"
220 PRINT
230 DIM A$(52),L(54)
240 FOR I=1 TO 52
250 READ A$(I)
...
500 B1=B1+1
510 PRINT "YOU WIN. YOU HAVE";B1;"AND THE COMPUTER HAS";A1;CHR$(8);"."
520 GOTO 540
530 PRINT "TIE.  NO SCORE CHANGE."
540 IF L(P+1)=0 THEN 610
550 PRINT "DO YOU WANT TO CONTINUE";
560 INPUT V$
570 IF LEFT$(V$,1)="Y" THEN 360
580 IF LEFT$(V$,1)="N" THEN 650
