...
140 PRINT
145 PRINT "YOU GOT ";
150 IF Q=1 THEN PRINT "ONE "; ELSE IF Q=2 THEN PRINT "TWO "; ELSE IF Q=3 THEN
    PRINT "THREE "; ELSE PRINT "NONE ";
152 PRINT "OUT OF THREE CORRECT.":PRINT
155 PRINT:LINE INPUT "DO YOU WANT TO TRY AGAIN? ";ANS$
156 IF LEFT$(ANS$,1)="N" THEN RUN "MENU"
160 IF Q<2 THEN 100
170 PRINT "  NOT BAD."
180 GOTO 100
500 INPUT G
