...
2 PRINT TAB(31);"BLACK JACK":PRINT
...
120 PRINT:PRINT CHR$(22);"               "
122 PRINT "  RESHUFFLING  "
124 PRINT "               ";CHR$(22):PRINT
...
1755 PRINT
1756 PRINT "   To stop the game, enter a negative number for any bet.":
     PRINT
1760 PRINT:PRINT "NUMBER OF PLAYERS";
1770 INPUT N
1775 PRINT
1780 IF N<1 OR N>7 OR N>INT(N) THEN 1760
1781 FOR I=1 TO N
1782 PRINT "NAME OF PLAYER #";I;:INPUT PLAYER$(I)
1783 NEXT I
...
1880 PRINT "BETS:":PRINT "----":PRINT
1890 FOR I=1 TO N: PRINT PLAYER$(I);: INPUT Z(I):IF Z(I)>500 THEN PRINT
     "HOUSE LIMIT IS $500.":PRINT PLAYER$(I);:INPUT Z(I)
1891 IF Z(I)<0 THEN RUN "MENU"
1892 NEXT I
1895 PRINT
1900 FOR I=1 TO N
1910 IF Z(I)<=0 OR Z(I)>500 THEN PRINT:PRINT "HOUSE LIMIT IS $500.":
...
2130 PRINT:PRINT "ANY INSURANCE";
2140 INPUT H$
2150 IF LEFT$(H$,1)<>"Y" THEN 2240
2160 PRINT:PRINT "INSURANCE BETS":PRINT "--------------"
2170 FOR I=1 TO N: PRINT PLAYER$(I);: INPUT Z(I): NEXT I
2180 FOR I=1 TO N
2190 IF Z(I)<0 OR Z(I)>B(I)/2 THEN 
     PRINT "MAXIMUM INSURANCE BET IS HALF THE INITIAL BET.":GOTO 2160
2200 NEXT I
2210 FOR I=1 TO N
...
2440 PRINT CHR$(22);"              ";CHR$(22)
2441 PRINT CHR$(22);"  BLACKJACK!  ";CHR$(22)
2442 PRINT CHR$(22);"              ";CHR$(22)
...
2620 PRINT:PRINT "SPLITTING NOT ALLOWED."
2630 GOTO 2370
...
2680 B(I+D1)=B(I)
2690 GOSUB 100
2700 PRINT:PRINT "FIRST HAND RECEIVES A";
2710 GOSUB 700
2720 P(I,2)=X
2730 GOSUB 300
2740 PRINT
2750 GOSUB 100
2760 PRINT:PRINT "SECOND HAND RECEIVES A";
2770 I=I1
2780 GOSUB 700
2790 P(I,2)=X
2800 GOSUB 300
...
2950 NEXT I
2960 PRINT:PRINT "DEALER HAD A";
2970 X=P(D1,2)
2980 GOSUB 700
2990 PRINT " CONCEALED."
3000 GOTO 3140
3010 PRINT:PRINT "DEALER HAS A";MID$(D$,3*P(D1,2)-2,3);" CONCEALED ";
3020 I=D1
...
3230 'PRINT "      ";
3240 GOTO 3260
3250 PRINT USING "$$##";ABS(S(I));
3260 T(I)=T(I)+S(I)
3270 PRINT TAB(35);"TOTAL =";:PRINT USING "$$#,###-";T(I)
3280 GOSUB 1200
3290 T(D1)=T(D1)-S(I)
3300 I=I+D1
3310 GOSUB 1200
3320 I=I-D1
3330 NEXT I
3340 PRINT:PRINT "DEALER'S TOTAL =";:PRINT TAB(42);:PRINT USING "$$#,###-";T(D1)
3345 PRINT
3350 GOSUB 1200
3360 GOTO 1810
3370 RUN "MENU"
