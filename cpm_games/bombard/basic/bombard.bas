...
10 PRINT TAB(33);"BOMBARDMENT":PRINT
...
200 PRINT
201 LINE INPUT "ENTER 'RETURN' TO CONTINUE.";XX$
202 PRINT CHR$(26)
210 PRINT "HERE IS A PRINTED MATRIX FOR YOU TO TEAR OFF AND CHECK"
211 PRINT "OFF THE NUMBERS:":PRINT:PRINT:PRINT "--  Printing  --":PRINT:PRINT
260 DIM M(100)
270 FOR R=1 TO 5
280 I=(R-1)*5+1
290 LPRINT USING "   ##     ##     ##     ##     ##";I,I+1,I+2,I+3,I+4
300 NEXT R
350 LPRINT CHR$(12)
...
670 PRINT "I MISSED YOU, YOU DIRTY RAT. I PICKED";M;CHR$(8);". YOUR TURN:"
