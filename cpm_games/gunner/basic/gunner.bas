...
180 PRINT "MAXIMUM RANGE OF YOUR GUN IS";:PRINT USING "###,###";R;:
    PRINT " YARDS."
185 Z=0
190 PRINT
195 S1=0
...
260 GOTO 390
270 PRINT "OVER TARGET BY ";:PRINT USING "##,###";ABS(E);:PRINT " YARDS."
280 GOTO 390
290 PRINT "SHORT OF TARGET BY ";:PRINT USING "##,###";ABS(E);:PRINT " YARDS."
300 GOTO 390
...
360 GOTO 200
370 PRINT "DISTANCE TO THE TARGET IS ";:PRINT USING "##,###";T;:PRINT " YARDS."
380 PRINT
390 PRINT
...
510 IF LEFT$(Z$,1)="Y" THEN 170
520 PRINT:PRINT "OK.  RETURN TO BASE CAMP.":PRINT
999 RUN "MENU"
