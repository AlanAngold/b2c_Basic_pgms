1 DIM F(4) 
2 PRINT CHR$(26);TAB(31);"FUR TRADER":PRINT
4 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY"
6 PRINT: PRINT: PRINT
15 GOSUB 1091 
16 LET I=600
17 PRINT:PRINT:PRINT "DO YOU WISH TO TRADE FURS"; 
18 GOSUB 1402 
19 IF LEFT$(B$,1)="Y" THEN 100
20 IF LEFT$(B$,1)="Y" THEN 100
21 RUN "MENU"
100 PRINT
101 PRINT "YOU HAVE ";:PRINT USING "$$##.##";I;:PRINT " SAVINGS"
102 PRINT "AND 190 FURS TO BEGIN THE EXPEDITION."
261 LET E1=INT((.15*RND(1)+.95)*10^2+.5)/10^2
262 LET B1=INT((.25*RND(1)+1!)*10^2+.5)/10^2
300 PRINT
...
350 GOTO 1100 
500 PRINT
501 PRINT:PRINT "YOU MAY NOT HAVE THAT MANY FURS."   
...
1099 RETURN 
1100 PRINT:PRINT "YOU MAY TRADE YOUR FURS AT FORT 1, FORT 2,"
...
1110 PRINT:PRINT "WHICH FORT WOULD YOU LIKE TO TRADE AT";
1111 INPUT B:PRINT
...
1322 RETURN 
1400 PRINT:PRINT "DO YOU WANT TO TRADE AT ANOTHER FORT";
1402 INPUT B$:PRINT
1404 RETURN 
1410 PRINT
1412 PRINT "YOUR BEAVER SOLD FOR ";:PRINT USING "$$##.##";B1*F(2);:
     PRINT ", ";
1414 PRINT "YOUR FOX SOLD FOR ";:PRINT USING "$$##.##";D1*F(4);:
     PRINT ","
1416 PRINT "YOUR ERMINE SOLD FOR ";:PRINT USING "$$##.##";E1*F(3);:
     PRINT ", ";
1417 PRINT "YOUR MINK SOLD FOR ";:PRINT USING "$$##.##";M1*F(1);:
     PRINT "."
1418 LET I=M1*F(1)+B1*F(2)+E1*F(3)+D1*F(4)+I
1420 PRINT
1422 PRINT "YOU NOW HAVE ";:PRINT USING "$$##.##";I;:
     PRINT " INCLUDING YOUR PREVIOUS SAVINGS."
1425 GOTO 508
1430 FOR J=1 TO 4 
1432 LET F(J)=0 
1434 NEXT J 
