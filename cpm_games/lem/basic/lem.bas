...
160 PRINT " (YES OR NO)";
165 INPUT Q$
170 IF LEFT$(Q$,1)="Y" THEN 190
175 IF LEFT$(Q$,1)="N" THEN 205
180 PRINT "JUST ANSWER THE QUESTION, PLEASE, ";
185 GOTO 160
190 PRINT
195 PRINT "INPUT MEASUREMENT OPTION (METRIC OR ENGLISH)";
200 GOTO 225
205 PRINT
210 PRINT "WHICH SYSTEM OF MEASUREMENT DO YOU PREFER (METRIC OR ENGLISH)";
225 INPUT K$
226 IF LEFT$(K$,1)="M" THEN K=1 ELSE IF LEFT$(K$,1)="E" THEN K=0 ELSE GOTO 225
230 PRINT
235 IF K=0 THEN 280
240 IF K=1 THEN 250
245 GOTO 220
...
440 PRINT:LINE INPUT "ENTER 'RETURN' TO CONTINUE.";RESP$:PRINT CHR$(26)
...
565 PRINT:LINE INPUT "ENTER 'RETURN' TO START THE EXERCISE.";RESP$:
    PRINT CHR$(26)
566 PRINT " TIME";TAB(12);"HEIGHT";TAB(23);"DISTANCE";
567 PRINT TAB(37);"VERT. VEL.";TAB(49);"HOR. VEL.";TAB(60);"FUEL LEFT"
568 PRINT " ----";TAB(12);"------";TAB(23);"--------";
569 PRINT TAB(37);"----------";TAB(49);"---------";TAB(60);"---------":PRINT
570 GOTO 670
575 PRINT
580 PRINT "T,P,A";
585 INPUT T1,F,P
