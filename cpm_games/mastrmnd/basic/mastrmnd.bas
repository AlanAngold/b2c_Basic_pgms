...
2 PRINT TAB(30);"MASTERMIND":PRINT
...
240 NEXT X
241 PRINT:PRINT "ENTER GUESS AS CAPITAL LETTERS WITHOUT COMMAS":PRINT "OR SPACES, OR ENTER 'BOARD' OR 'QUIT'"
260 FOR R=1 TO R9
270 PRINT 
...
730 LINE INPUT "HIT 'RETURN' WHEN READY:";X$:PRINT
740 FOR M=1 TO 10
750 GOSUB 3000
...
1140 GOSUB 5000
1150 NEXT R
1160 PRINT:PRINT "GAME OVER"
1170 PRINT "FINAL SCORE:"
1175 PRINT "============"
1180 GOSUB 5040
1190 FOR XX=1 TO 2000:NEXT:RUN "MENU"
2000 REM
...
2565 PRINT
2570 PRINT "GOOD BYE"
2580 FOR XX=1 TO 2000:NEXT:RUN "MENU"
3000 REM
...
9999 FOR XX=1 TO 2000:NEXT:RUN "MENU"
