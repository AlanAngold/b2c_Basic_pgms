1  REM Written in HP Basic
2  REM From: http://www.langesite.com/startrader/
...
1450 REM T[7,T1]=T[7,T1]-X*(I1<5)
1451 IF I1>=5 THEN 1453
1452 T[7,T1]=T[7,T1]-X
1453 REM
...
1930 REM T[7,T1]=T[7,T1]+X*(I1<5)
1931 IF I1>=5 THEN 1933
1932 T[7,T1]=T[7,T1]+X
1933 REM
...
3110 REM I=(INT(RND(0)*3)+1)*(RND(0)>(Q/2))
3111 IF RND(0)>(Q/2) THEN 3114
3112 I=0
3113 GOTO 3115
3114 I=INT(RND(0)*3)+1
3115 REM
...
3870 REM R1=1+(S[7,S1] >= 5)+(S[7,S1] >= 10)
3871 R1=1
3872 IF S[7,S1] < 5 THEN 3874
3873 R1=R1+1
3874 IF S[7,S1] < 10 THEN 3876
3875 R1=R1+1
3876 REM
