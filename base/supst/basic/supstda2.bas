  ...
  490 Q1=FNR(0):Q2=FNR(0):S1=FNR(0):S2=FNR(0)
 ...
 1040 G(I,J)=K3*100+B3*10+FNR(0):NEXTJ:NEXTI:IFK9>T9THENT9=K9+1
 1100 IFB9<>0THEN1200
 1150 IFG(Q1,Q2)<200THENG(Q1,Q2)=G(Q1,Q2)+100:K9=K9+1
 1160 B9=1:G(Q1,Q2)=G(Q1,Q2)+10:Q1=FNR(0):Q2=FNR(0)
 1200 K7=K9:IFB9<>1THENX$="S":X0$=" ARE "
 1230 PRINT"YOUR ORDERS ARE AS FOLLOWS:"
 1240 PRINT"     DESTROY THE";K9;"KLINGONS WARSHIPS WHICH HAVE INVADED"
 ...
 1270 PRINT"  ";B9;"STARBASE";X$;" IN THE GALAXY FOR RESUPPLYING YOU SHIP"
 1280 PRINT:PRINT"HIT ANY KEY EXEPT RETURN WHEN READY TO ACCEPT COMMAND"
 1300 I=RND(0):IFINP(1)=13THEN1300
 ...
 1430 GOSUB9030:PRINT:IFT0<>TTHEN1490
 ...
 2910 R1=FNR(0):IFRND(0)>=.6THEN3000
 ...
 3930 PRINT"SHIELDS CONTROL SUPPLIES ENERGY TO COMPLETE THE MANEUVER."
 3940 S=S+E:E=0:IFS<=0THENS=0
 3980 RETURN
 3990 REM LONG RANGE SENSOR SCAN CODE
 4000 IFD(3)<0THENPRINT"LONG RANGE SCAN SENSORS ARE INOPERABLE":GOTO1990
 4030 PRINT"LONG RANGE SCAN FOR QUADRANT";Q1;",";Q2
 4040 O1$="-------------------":PRINTO1$
 4060 FORI=Q1-1TOQ1+1:N(1)=-1:N(2)=-2:N(3)=-3:FORJ=Q2-1TOQ2+1
 4120 IF(I>0ANDI<9		)AND(J>0ANDJ<9)THENG(I,J)=(J-Q2+2):Z(I,J)=G(I,J)
 ...
 4700 IFP<=0THENPRINT"ALL PHOTON TORPEDOES EXPENDED":GOTO1990
 ...
 6060 H=INT((KK(I,3)/FND(0))*(2+RND(0))):S=S-H:K(I,3)=K(I,3)/(3+RND(0))
 ...
 6140 R1=FNR(0):D(R1)=D(R1)-H/S-.5*RND(0):GOSUB8790
 ...
 6250 PRINT"WILL BE CONQUERED":GOTO6220
 ...
 6380 PRINT"MENECING THE FEDERATION HAS BEEN DESTROYED.":PRINT
 ...
 6820 FORJ=(I-1)*24+1TO(I-4)*24+22STEP3:PRINT" ";MID$(Q$,J,3);:NEXTJ
 ...
 7542 IFA$="Y"THENPOKE1229,2:POKE1237,3:
 7543 PRINT:PRINT"        ";
 ...
 7800 Z5=5:GOSUB9030:J0=INT(39-.5*LEN(G2$)):PRINTTAB(J0);G2$;
 7850 PRINT:PRINTO1$:NEXTI:PRINT:POKE1229,0:POKE1237,1:GOTO1990
 ...
 7970 X$="S":IFB0<2THENX$="":IFB9<1THEN8010
 7980 PRINT"THE FEDERATION IS MAINTAINING";B9;"STARBASES";X$;" IN THE GALAXY"
 7990 GOTO5690
 ...
 8100 H8=0:FORI=1TO3:IF(I,3)<=0THEN8480
 ...
 8480 NEXTI:GOTO1990
 8500 IFB3<>0THENPRINT"FORM ENTERPRISE TO STARBASE:":W1=B4:X=B5:GOTO8120
 ...
 8590 R1=FNR(0):R2=FNR(0):A$="  ":Z1=R1:Z2=R2:GOSUB8830:IFZ2=0THEN8590
 8600 RETURN
 8660 REM INSERT IN STRING ARRAY FOR QUADRANT
 8670 S8=INT(Z2-.5)*3+INT(Z1-.5)*24+1
 8675 IF LEN(A$)<>3THEN PRINT"ERROR":END
 ...
 9120 ONZ4GOTO9130,9140,9150,9160
