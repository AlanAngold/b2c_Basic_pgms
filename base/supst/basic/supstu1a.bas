  ...
  140 P=10:P0=P:S9=200:S=0:B9=0:K9=0:X$=" ":X0$=" IS "
  170 Q1=RND(8):Q2=RND(8):S1=RND(8):S2=RND(8)
  180 FOR I=1TO9:C(I,1)=0:C(I,2)=0:NEXT I
  190 C(3,1)=-1:C(2,1)=-1:C(4,1)=-1:C(4,2)=-1:C(5,2)=-1:C(6,2)=-1
  200 C(1,2)=1:C(2,2)=1:C(6,1)=1:C(7,1)=1:C(8,1)=1:C(8,2)=1:C(9,2)=1
  210 FOR I =1TO8:D(I)=0:NEXT I
  220 A1$="NAVSRSLRSPHATORSHEDAMCOMXXX"
  230 FOR I=1TO8:FOR J=1TO8:K3=0:Z(I,J)=0:R1=RND(0)
  240 IFR1>.98 THEN K3=3:K9=K9+3:GOTO270
  250 IF R1>.95 THEN K3=2:K9=K9+2:GOTO270
  260 IF R1>.8THEN K3=1:K9=K9+1
  ...
  320 K7=K9:IFB9<>1 THEN X$="S":X0$=" ARE "
  330 PRINT"YOUR ORDERS ARE AS FOLLOWS:"
  ...
  370 PRINT"   ";B9;"STARBASE";X$;" IN THE GALAXY FOR RESUPPLYING YOUR SHIP"
  380 PRINT:INPUT"ENTER YOUR NAME INTO THE CAPTAIN'S LOG";NA$
  400 Z4=Q1:Z5=Q2:K3=0:B3=0:S3=0:G5=0:D4=.5*RND(0):Z(Q1,Q2)=G(Q1,Q2)
  410 IFQ1<1ORQ1>8ORQ2<1ORQ2>8THEN510
  450 REM
  460 FOR I=1TO200:NEXTI:K3=INT(G(Q1,Q2)*.01):B3=INT(G(Q1,Q2)*.1)-10*K3
  470 S3=G(Q1,Q2)-100*K3:IF K3=0THEN500
  480 CLS:PRINT@396,"COMBAT AREA     CONDITION RED":IFS>200THEN500
  490 PRINT@463,"SHIELDS DANGEROUSLY LOW"
  500 FORI=1TO3:K(I,2)=0:K(I,1)=0:NEXT I
  510 FOR I=1TO3:K(I,3)=0:NEXTI:Q$=Z$+Z$+Z$+Z$+Z$+Z$+Z$+LEFT$(Z$,17)
  520 A$="<*>":Z1=S1:Z2=S2:GOSUB3320:IFK3<1THEN550
  530 FOR I=1TOK3:GOSUB3300:A$="+K+":Z1=R1:Z2=R2
  540 GOSUB3320:K(I,1)=R1:K(I,2)=R2:K(I,3)=S9*(.5+RND(0)):NEXT I
  550 IFB3<1THEN570
  560 GOSUB3300:A$=">!<":Z1=R1:B4=R1:Z2=R2:B5=R2:GOSUB3320
  570 FOR I=1TOS3:GOSUB3300:A$=" * ":Z1=R1:Z2=R2:GOSUB3320:NEXTI
  580 GOSUB2460
  590 IFS+E>10THENIFE>10ORD(7)=0THEN640
  600 CLS:PRINT@320,"CAPTAIN";NA$;"!   YOU HAVE JUST STRANDED YOUR SHIP IN SPACE!"
  610 PRINT"YOU HAVE INSUFFICIENT MANEUVERING ENERGY,";
  620 PRINT"AND THE SHIELD CONTROL":PRINT"IS PRESENTLY INCAPABLE OF CROSS";
  630 PRINT"-CURCUITING TO ENGINE ROOM !!!":GOTO2330
  640 PRINT"YOUR ORDERS, CAPTAIN ";NA$;:INPUTA$
  650 FOR I=1TO9:IFLEFT$(A$,3)<>MID$(A1$,3*I-2,3)THEN670
  660 ONIGOTO770,580,1410,1490,1680,1990,2070,2680,2360
  670 NEXTI:CLS:PRINT"ENTER ONE OF THE FOLLOWING:"
  680 PRINT"  NAV   (TO SET COURSE)"
  690 PRINT"  SRS   (SHORT RANGE SENSOR SCAN)"
  700 PRINT"  LRS   (LONG RANGE SENSOR SCAN)"
  710 PRINT"  PHA   (TO FIRE PHASER)"
  720 PRINT"  TOR   (TO FIRE TORPEDOES)"
  730 PRINT"  SHE   (TO RAISE OR LOWER SHIELDS)"
  740 PRINT"  DAM   (FOR DAMAGE CONTROL REPORT)"
  750 PRINT"  COM   (TO CALL 0N LIBRARY-COMPUTER)"
  760 PRINT"  XXX   (TO RESIGN YOUR COMMAND)":PRINT:GOTO590
  770 INPUT "COURSE (0-9)";C1:IF C1=9THEN C1=1
  780 IFC1>=1ANDC1<9THEN800
  790 PRINT"   LT. SULU REPORTS, 'INCORRECT COURSE DATA, SIR!'":GOTO590
  800 X$="8":IFD(1)<0THENX$="0.2"
  810 PRINT"WARP FACTOR (0-";X$;")";:INPUTW1:IFD(1)<0ANDW1>.2THEN860
  820 IFW1>0 AND W1<=8 THEN 870
  830 IF W1=0 THEN 590
  840 PRINT"  CHIEF ENGINER SCOTT REPORTS 'THE ENGINES WON'T TAKE W<ERROR>ARP";W1;"'":GOTO590
  860 PRINT"WARP ENGINES ARE DAMAGED.  MAXIMUM SPEED = WARP 0.2":GOTO 590
  870 N=INT(W1*8+.5):IF E-N>=0 THEN 940
  880 PRINT"ENGINEERING REPORTS  'INSUFFICIENT ENERGY AVAILABLE"
  890 PRINTTAB(23);"FOR MANEUVERING AT WARP";W1;"'"
  900 IF S<N-EORD(7)<0 THEN 590
  910 PRINT"DEFLECTOR CONTROL ROOM ACKNOWLEDGES";S;"UNITS OF ENERGY"
  920 PRINTTAB(23);"PRESENTLY DEPLOYED TO SHIELDS."
  930 GOTO 590
  940 FOR I=1TOK3:IF K(I,3)=0THEN 970
  950 A$="   ":Z1=K(I,1):Z2=K(I,2):GOSUB3320:GOSUB 3300
  960 K(I,1)=Z1:K(I,2)=Z2:A$="+K+":GOSUB3320
  970 NEXTI:GOSUB2220:D1=0:D6=W1:IFW1>=1THEND6=1
  980 FOR I=1TO8:IFD(I)>=0THEN1030
  990 D(I)=D(I)+D6:IF D(I)>-.1ANDD(I)<0THEN D(I)=-.1:GOTO1030
 1000 IF D(I)<0THEN1030
 1010 IFD1<>1THEND1=1:PRINT"1 DAMAGE CONTROL REPORT:"
 1020 PRINTTAB(8);:R1=I:GOSUB3370:PRINTG2$;" REPAIR COMPLETED."
 ...
 1080 GOSUB3370:PRINTD2$;" STATE OF REPAIR IMPROVED":PRINT
 ...
 1150 PRINT"SECTOR";S1;",";S2;" DUE TO BAD NAVAGATION":GOTO1170
 ...
 1280 IFX5=0THEN1350
 1290 PRINT"LT. UHURA REPORTS MESSAGE FROM STARFLEET COMMAND:"
 1300 PRINT" 'PERMISSION TO ATTEMPT CROSSING OF GALATIC PERIMETER"
 1310 PRINT" IS HEREBY *DENIED* SHUT DOWN YOUR ENGINES.'"
 1320 PRINT"CHIEF ENGINEER SCOTT REPORTS 'WARP ENGINES SHUT DOWN"
 1330 PRINT" AT SECTOR";S1;",";S2;"OF QUADRANT";Q1;",";Q2;".'"
 1340 IFT>T0+T9 THEN 2330
 1350 IF8*Q1+Q2=8*Q4+Q5 THEN 1170
 1360 T=T+1:GOSUB 1370:GOTO400
 1370 E=E-N-10:IFE>=0THENRETURN
 1380 PRINT"SHIELD CONTROL SUPPLIES ENERGY TO COMPLETE THE MANEUVER."
 1390 S=S+E:E=0:IFS<=0 THENS=0
 1400 RETURN
 1410 IFD(3)<0 THENPRINT"LONG RANGE SENSORS ARE INOPERABLE":GOTO590
 1420 CLS:PRINT"LONG RANGE SCAN FOR QUADRANT";Q1;",";Q2
 1430 O1$="---------------":PRINTO1$
 1440 FORI=Q1-1TOQ1+1:N(1)=-1:N(2)=-2:N(3)=-3:FOR J=Q2-1TOQ2+1
 ...
 1500 IFK3>0THEN1530
 1510 PRINT"SCIENCE OFFICER SPOCK REPORTS 'SENSORS SHOW NO ENEMY SHIPS"
 1520 PRINTTAB(32)"IN THIS QUADRANT'":GOTO590
 1530 IFD(8)<0THENPRINT"COMPUTER FAILURE HAMPERS ACCURACY"
 1540 PRINT"PHASERS LOCKED ON TARGET; ";
 1550 PRINT"ENERGY AVAILABLE=";E;"UNITS"
 1560 INPUT"NUMBER OF UNITS TO FIRE";X:IFX<=0THEN590
 ...
 1604 H=INT((H1/JH)*(RND(0)+2)):IF H>.15*K(I,3) THEN1620
 1610 PRINT"SENSORS SHOW NO DAMAGE TO ENEMY AT ";K(I,1);",";K(I,2):GOTO1670
 1620 K(I,3)=K(I,3)-H:PRINTH;"UNIT HIT ON KLINGON AT SECTOR";K(I,1);",";
 1630 PRINTK(I,2):IF K(I,3)<0THENPRINT"*** KLINGON DESTROYED ***":GOTO1650
 1640 PRINT"  (SENSORS SHOW";K(I,3);"UNITS REMAINING)  ":GOTO1670
 1650 K3=K3-1:K9=K9-1:Z1=K(I,1):Z2=K(I,2):A$="   ":GOSUB3320
 1660 K(I,3)=0:G(Q1,Q2)=G(Q1,Q2)-100:Z(Q1,Q2)=G(Q1,Q2):IFK9<=0THEN 2430
 1670 NEXTI:GOSUB2220:GOTO590
 1680 REM
 1685  IFP<0 PRINT"ALL PHOTON TORPEDOES EXPENDED":GOTO590
 1690 IF D(5)<0 THEN PRINT"PHOTON TUBES ARE NOT OPERATIONAL":GOTO590
 1700 INPUT"PHOTON TORPEDO COURSE (1-9)";C1:IF C1=9 THENC1=1
 1710 IF C1>=1 AND C1<9 THEN 1740
 1720 PRINT"ENSIGN CHEKOV REPORT, 'INCORRECT COURSE DATA, SIR!'"
 1730 GOTO590
 ...
 1780 IF X3<1ORX3>8ORY3<1ORY3>8THEN1980
 1785 PRINT@832,STRING$(63," ")
 1790 PRINT@832,"TRACKING TORPEDO:";X3;",";Y3;
 1795 A$="   ":Z1=X:Z2=Y:GOSUB 3460
 1800 IF Z3<>0THEN1770
 1805 PRINT
 ...
 1890 PRINT"*** STAR BASE DESTROYED ***":B3=B3-1:B9=B9-1
 1900 IFB9>0ORK9>T-T0-T9THEN1940
 1909 NA$="WALDO"
 1910 PRINT"CAPTAIN ";NA$;",YOU ARE HEREBY RELIEVED OF YOUR COMMAND"
 1920 PRINT"AND SENTENCED TO 99 STARDATES AT HARD LABOUR ON CYGNUS 12!!!"
 1925 FOR II=1TO2500
 1926 NEXT II
 1930 GOTO2360
 1940 PRINT"STARFLEET COMMAND REVIEWING YOUR RECORD TO CONSIDER"
 1950 PRINT"COURT MARTIAL!!!!!":D0=0
 ...
 2000 PRINT"ENERGY AVAILABLE =";E+S;:INPUT"NUMBER OF UNITS TO SHIELDS";X
 2010 IF X<0ORS=XTHENPRINT"<SHIELDS UNCHANGED>";GOTO590
 2020 IFX<=E+STHEN2050
 2030 PRINT"CAPTAIN "NA$"!!!  THIS IS NOT THE FEDERATION TREASURY"
 2040 PRINT"<SHIELDS UNCHANGED>":GOTO590
 2050 E=E+S-X:S=X:PRINT"DEFLECTER CONTROL ROOM REPORT:"
 2060 PRINT"  'SHIELDS NOW AT ";INT(S);"UNITS PER YOUR COMMAND'"
 2065 FORII=1TO500:NEXTII:CLS:GOSUB2460:GOTO590
 2070 IF D(6)>=0THEN2180
 2080 PRINT"DAMAGE CONTROL REPORT NOT AVAILABLE":IFD=0THEN590
 2090 D3=0:FOR I=1TO8:IF D(I)<0THEND3=D3+.1
 2100 NEXT I:IFD3=0THEN590
 2110 PRINT:D3=D3+4:IFD3>=1THEND3=.9
 2120 PRINT"TECHNICIANS STANDING BY TO EFFECT REPAIRS TO YOUR SHIP;"
 2130 PRINT"ESTIMATED TIME OF REPAIR :";.01*INT(100*D3);"STARDATES"
 2140 INPUT"WILL YOU AUTHORIZE THE REPAIR ORDER (Y/N)";A$
 2150 IFA$<>"Y"THEN590
 2160 FOR I=1TO8:IFD(I)<0THEN D(I)=0
 2170 NEXTI:T=T+D3+.1
 2180 CLS:PRINT:PRINT"DEVICE   STATE OF REPAIR":FOR R1=1TO8
 2190 GOSUB3370:PRINTG2$;LEFT$(Z$,25-LEN(G2$));INT(D(R1)*100)*.01
 2200 NEXT R1:PRINT:IFD0<>0THEN2090
 2210 GOTO590
 ...
 2340 CLS:PRINT:PRINT"THE ENTERPRISE HAS BEEN DESTROYED "::PRINT"THE FEDERATION";
 ...
 2400 PRINT"FOR A SIMILAR MISSION -- IF THERE IS A FOOL AMONG YOU,"
 2410 INPUT"LET HIM STEP FORWARD AND ENTER 'AYE'";A$:IFA$="AYE"THEN10
 2420 END
 2425 T=100:B9=1
 2430 FORII=1TO1500:NEXTII:CLS
 2435 PRINT@192,"CONGRATULATIONS, MON CAPITAN ";NA$;"!   THE LAST KLINGON BATTLE"
 ...
 2510 PRINT"SHIELDS DROPPED FOR DOCKING PURPOSES":FORIX=1TO500:NEXTIX:S=0:GOTO2540
 ...
 2690 INPUT"COMPUTER ACTIVE AND AWAITING COMMAND";A:IFA<0ORA>4THEN2710
 2700 H8=1:ONA+1GOTO2810,2930,3010,3270,3070
 2710 CLS:PRINT"FUNCTIONS AVAILABLE FROM LIBRARY COMPUTER"
 2720 PRINT"     0=CUMULATIVE GALACTIC RECORD"
 2730 PRINT"     1=STATUS REPORT"
 2740 PRINT"     2=PHOTON TORPEDO DATA"
 2750 PRINT"     3=STARBASE NAVAGATION DATA"
 2760 PRINT"     4=DIRECTION/DISTANCE CALCULATOR"
 2770 PRINT:GOTO2690
 2780 H8=0:G5=1:CLS:PRINTTAB(24);"THE GALAXY":GOTO2840
 2810 PRINT:PRINT"          ";
 2820 CLS:PRINT"COMPUTER RECORD OF GALAXY FOR QUADRANT";Q1;",";Q2
 2830 PRINT
 2840 PRINT"       1     2     3     4     5     6     7     8"
 2850 O1$="     ----- ----- ----- ----- ----- ----- ----- -----"
 2860 PRINTO1$:FORI=1TO8:PRINTI;:IFH8=0THEN2900
 ...
 2910 Z5=5:GOSUB3490:J0=INT(39-.5*LEN(G2$)):PRINTTAB(J0);G2$;
 2920 PRINT:NEXTI:PRINT:GOTO590
 2930 CLS:PRINT"     STATUS REPORT ":X$=" ":IFK9>1THENX$="S"
 2940 PRINT"KLINGON";X4;" LEFT: ";K9
 2950 PRINT"MISSION MUST BE COMPLETED IN";.1*INT((T0+T9-T)*10);"STARDATES"
 2960 X$="S":IFB9<2THENX$=" ":IFB9<1THEN2990
 2970 PRINT"THE FEDERATION IS MAINTAINING";B9;"STARBASE";X$;" IN THE GALAXY"
 2975 FORIX=1TO500:NEXTIX
 2980 GOTO2070
 2990 PRINT"CAPTAN ";NA$;" !!  YOUR STUPIDITY HAS LEFT YOU ON YOUR OWN"
 3000 PRINT"IN THE GALAXY -- YOU HAVE NO STARBASES LEFT!!!!!!"
 3005 FORII=1TO500:NEXTII:GOTO2070
 3010 IFK3<=0THEN1510
 ...
 3070 CLS:PRINT"DIRECTION/DISTANCE CALCULATOR:"
 3080 PRINT"YOU ARE AT QUADRANT ";Q1;",";Q2;" SECTOR ";S1;",";S2
 ...
 3180 PRINT"DIRECTION =";C1+(ABS(A)/(ABS(A)+.001));:GOTO3250
 ...
 3250 PRINT"DISTANCE =";
 3252 IFW1=B4THENPRINTSQR(X^2+A^2)/10:GOTO3254
 3253 PRINTSQR(X^2+A^2)
 3254 IFH=1THEN590
 3260 NEXTI:GOTO590
 3270 IFB3<>0THENPRINT"FROM ENTERPRISE TO STARBASE:":W1=B4:X=B5:GOTO3060
 ...
 3330 IFLEN(A$)<>3THEN PRINT"ERROR":STOP
 ...
 3390 G2$="SHORT RANGE SENSORS":RETURN
 3400 G2$="LONG RANGE SENSORS":RETURN
 3410 G2$="PHASER CONTROL":RETURN
 3420 G2$="PHOTON TUBES":RETURN
 3430 G2$="DAMAGE CONTROL":RETURN
