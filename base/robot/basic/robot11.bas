  ...
  100 '<ERROR><ERROR>****************************************<ERROR>ROBOTS BY LANCE MICKLUS, COPYRIGHT 1978<ERROR>VERSION 1.1<ERROR>****************************************<ERROR><ERROR>
  120 DEFINT A-Z
  140 DIM PO(50)
  160 CLS
  ...
  240 FE=5 : RT=20
  260 '<ERROR><ERROR>GET INITIAL CONDITIONS
  ...
  720 '<ERROR><ERROR>DRAW PLAYING FIELD
  740 CLS
  760 FOR Y=0 TO 47
  780 SET(0,Y)
  800 SET(1,Y)
