   ...
   16 SD=SD+.001:PRINT@44,"STARDATE: ";:PRINTLLIST"###.#";SD;:PRINT@108,"MODE:";:PRINT@300,BF"S : "F;:PRINT@364,BT"S :";:PRINT@427,TE"EMPTY,"TF"FULL";:PRINT@492,BS"S : "V;:PRINT@556,"CREDITS : ";:PRINTLLIST"#####";M;
   ...
   60 PRINT@579,"POPULATION: ";:B="###.#":IFPS(XU)<2THEN62ELSEQX=RO(XU)*10:IFQX>999THENQX=QX/1000:PRINTLLISTB;QX;:PRINT" BILLION";ELSEPRINTLLISTB;QX;:PRINT" MILLION";
   61 GOTO63
