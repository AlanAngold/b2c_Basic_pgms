    ...
    1 ' WILL WORK WITH LEVEL II BASIC, 16K
  ...
  465 IFR=3PRINT"WHEN YOU CAN SEE AGAIN, YOU NOTICE THE EAST EXIT IS UNBLOCKED":E(R)=4:B$="WAL":GOSUB1130:GOTO150ELSEPRINT"BUT, NOTHING SEEMS AFFECTED.":GOTO150
  470 IFR$<>"SKU"THEN480ELSEPRINT"AS THE SKULL SHATTERS YOU SEE A RUBY, IT MUST HAVE BEEN INSIDETHE SKULL!!":B$="SKU":GOSUB1100
  ...
  645 GOTO150
  650 IFL$="MOV"ORL$="SLI"ORL$="ROL"ORL$="PUS"THEN660ELSE700  
 ...
 1205 'ADD B$ TO ROOM INVENTORY
 1210 IF I(R)=11 PRINT"THE ROOMS FULL.":RETURN 'FIX IT!!
 1220 I(R)=I(R)+1:I$(R,I(R))="THERE'S A "+B$+" HERE.":RETURN
 3000 'DATA - WHEN THE TEXT SUDDENLY GOES DOWN LIKE THIS, IT'S A LINEFEED.
