   ...
   60 FOR II=1TO1500:NEXT
   70 CLS
   80 PRINT:PRINT
   90 PRINTTAB(6)"WHILE I AM PLANNING MY BOARD, YOU CAN BE THINKING OF"
  100 PRINT
  110 PRINTTAB(8)"THE LAY OUT FOR YOUR SHIPS. YOUR SHIPS INCLUDE:"
  120 PRINT
  130 PRINTTAB(15)"A BATTLESHIP, (FIVE CO-ORDINATES LONG)"
  140 PRINT
  150 PRINTTAB(15)"A CRUISER, (THREE CO-ORDINATES LONG)"
  160 PRINT
  170 PRINTTAB(15)"DESTROYER <A>"
  180 PRINT
  200 '
