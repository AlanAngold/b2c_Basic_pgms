 ...
 1680 REM 
 1685 IF P<0 THEN PRINT "ALL PHOTON TORPEDOES EXPENDED.": GOTO 590
 1690 IF D(5)<0 THEN PRINT "PHOTON TUBES ARE NOT OPERATIONAL": GOTO 590
 1700 INPUT "PHOTON TORPEDO COURSE(1-9)";C1: IF C1=9 THEN C1=1
 ...
 2065 FOR II=1 TO 1500: NEXT : CLS : GOSUB 2460: GOTO 590
 2070 IF D(6)>=0 THEN 2180
 2080 PRINT "DAMMAGE CONTROL REPORT NOT AVAILABLE": IF D=0 THEN 590
 2090 D3=0:FOR TI=1 TO 8: IF D(I)<0 THEN D3=D3+.1
 ...
 2160 FOR I=1 TO 8:IF HD(I)<0 THEN D(I)=0
 ...
 2340 FOR I=1 TO 500: NEXT I: CLS : PRINT : PRINT "THE ENTERPRISE HAS BEEN DESTROYED.": PRINT "THE FEDERATION";
 ...
 2420 END 
 2425 T=100:B9=1
 2430 FOR II=1 TO 1500: NEXT : CLS 
 ...
 3250 PRINT "DISTANCE=";
 3252 IF W1=B4 THEN PRINT SQR(X^2+A^2)/10: GOTO 3254
