   ...
   95 S$(4)=S$(4)+CHR$(191)+CHR$(188)+CHR$(176)+CHR$(191)+CHR$(176)+"   "+CHR$(191)+CHR$(191)+CHR$(191)+CHR$(191)+CHR$(188)+CHR$(176)+"  "+CHR$(191)+STRING$(64,CHR$(131))
  ...
  140 INPUTX:IFX<1ORX>4THEN100ELSEONXGOTO500,600,700,800
 ...
 5000 PRINT@128,"SPEED AT IMPACT=";ABS(V2);" KM/HR";:PRINT@192,"ELAPSED TIME=";T1;" SECONDS.";:PRINT@256,"";:INPUT"TRY AGAIN 1/YES 2/NO";GG:IFGG<1ORGG>2THEN5000ELSEIFGG=1GOTO100ELSECLS:END
 ...
 6010 RETURN
 7000 VB=F/5:IFN3<1THEND=1ELSEIFN3<10THEND=2ELSEIFN3<25THEND=3ELSEIFN3<50THEND=4ELSEIFN3<100THEND=5ELSED=6
 ...
 7100 IFF=0RETURNELSEBL=NM+130:FORX=1TOVB:PRINT@BL,BL$;:FORJK=1TO5:NEXT:PRINT@BL,X$;:FORCX=1TO5:NEXT:PRINT@BL,BO$;:FORCV=1TO5:NEXT:PRINT@BL,X$;:NEXT:RETURN
 7150 RETURN
 7200 PRINT@512,S$(7);:IFN3<.10THENP=6ELSEIFN3<.2THENP=5ELSEIFN3<.3THENP=4ELSEIFN3<.6THENP=3ELSEIFN3<.8THENP=2ELSEP=1
 ...
 7270 VB=F*2:IFF=0RETURNELSEFORX=1TOVB:PRINT@NM+128-3,BS$;:FORVN=1TO25:NEXT:PRINT@NM+128-3,"            ";:FORVN=1TO5:NEXT:PRINT@NM-9+64,BB$;:FORVN=1TO10:NEXT:PRINT@NM-9+64,BT$;:FORVN=1TO5:NEXT:NEXT:RETURN
 8000 IFV2>45THEN8100ELSEIFV2>19THEN8200ELSEGOTO8300
 ...
 8200 BN=BN-1:PRINT@NM,X$;:PRINT@914,GA$;:FORCV=1TO5:X=RND(20)+39:FORY=42TO33STEP-1:SET(X,Y):RESET(X,Y):SET(X+4,Y):RESET(X+4,Y):NEXT:NEXT:IFBN<0THENRETURNELSEGOTO8200RETURN
