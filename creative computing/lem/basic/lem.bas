...
# trs2 - TRS-80 Level II BASIC tokenized file
  ...
  870 GOSUB 2660
  880 PRINT : PRINT : PRINT TAB 26);"* COURSE *"
  890 PRINT 
  900 PRINT TAB 27);"-180,180"
  910 PRINT TAB 31);"["
  920 PRINT TAB 24);" -90 <-+-> 90"
  930 PRINT TAB 31);"!"
  940 PRINT TAB 31);"0"
  950 GOSUB 2660
  960 PRINT TAB 20);"<< DIRECTION OF ORBIT <<"
  970 PRINT 
  980 PRINT TAB 24);"SURFACE OF MOON"
  990 PRINT 
 1000 PRINT 
 ...
 1880 PRINT TAB 28);H1; TAB 35);D1; TAB 45);T2
