...
# trs2 - TRS-80 Level II BASIC tokenized file
  ...
  100 A$ = INKEY$ : IF A$ = ""THEN 100 : ELSE CLS 
  ...
  450 GOTO 420
  460 FOR Z = 1 TO 10
  470 FOR Y = 1 TO 100 : NEXT Y : POKE B,65
  ...
  660 FOR Z = 1 TO 5
  670 FOR Y = 1 TO 100 : NEXT Y : POKE B,65
  680 FOR Y = 1 TO 100 : NEXT Y : POKE B,32
  690 NEXT Z : GOTO 1120
  ...
  810 IF C1 > Y AND C1 < Y + 51 THEN Y = 16070 : NEXT Y : GOTO 820 : ELSE NEXT Y : Z = 16 : NEXT Z : GOTO 1120
  820 IF PEEK (C1) = 42 THEN Z = 16 : NEXT Z : GOTO 1120
  821 POKE C1,46 : NEXT Z
  830 POKE C1,32 : GOTO 1120
  840 FOR Z = 1 TO 7
  850 FOR Y = 1 TO 100 : NEXT Y : POKE B,65
  860 FOR Y = 1 TO 100 : NEXT Y : POKE B,32
  870 NEXT Z
  880 PRINT @896,"YOU HAVE DESTROYED THE ROMULAN!";
  890 A$ = INKEY$ : IF A$ = ""THEN 890 : ELSE RUN 
 ...
 1080 POKE A2,32 : POKE A1,86 : NEXT Z
 1090 A = A1 : GOTO 1120
 1100 A = A2
 ...
 1830 IF PEEK (C3) = 42 THEN Z = 11 : NEXT Z : GOTO 1850 : ELSE POKE C3,43 : FOR Y = 1 TO 25 : NEXT Y : NEXT Z
 1840 POKE C3,32
 1850 GOTO 500
 1860 FOR Z = 1 TO 7
 1870 FOR Y = 1 TO 100 : NEXT Y : POKE A,86
 1880 FOR Y = 1 TO 100 : NEXT Y : POKE A,32
 1890 NEXT Z
 1900 PRINT @896,"YOU HAVE BEEN DESTROYED BY THE ROMULAN!";
 1910 A$ = INKEY$ : IF A$ = ""THEN 1910 : ELSE RUN 
 1920 END 
 1930 POKE A2,32 : POKE B2,32
 1940 PRINT @896,"YOU AND THE ROMULAN HAVE COLLIDED WITH EACH OTHER!";
 1950 FOR Z = 1 TO 7
 1960 FOR Y = 1 TO 100 : NEXT Y : POKE B,86
 1970 FOR Y = 1 TO 100 : NEXT Y : POKE B,65
 1980 NEXT Z
 1990 POKE B,32
 2000 A$ = INKEY$ : IF A%$ = ""THEN 2000 : ELSE RUN 
 ...
 2090 A$ = INKEY$ : IF A$ = ""THEN 2090 : ELSE RUN 
 2100 RETURN 
