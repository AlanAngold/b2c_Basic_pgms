...
# trs2 - TRS-80 Level II BASIC tokenized file
  ...
  120 PRINT TAB 12);"LIST OF THE LEGAL COMMANDS PRINTED OUT."
  130 GOSUB 1450
  ...
  170 PRINT TAB 22);"WILL BE ABORTED."
  180 GOSUB 1450
  190 PRINT : PRINT 
  ...
  430 GOSUB 1450
  440 PRINT @256,""
  450 PRINT TAB 15);"ONE WARP FACTOR IS THE SIZE OF"
  460 PRINT TAB 14);"ONE QUARDRANT.  THEREFORE, TO GET"
  470 PRINT TAB 13);"FROM QUARDRANT 6,5 TO 5,5 YOU WOULD"
  480 PRINT TAB 16);"USE COURSE 3, WARP FACTOR 1."
  490 GOSUB 1450
